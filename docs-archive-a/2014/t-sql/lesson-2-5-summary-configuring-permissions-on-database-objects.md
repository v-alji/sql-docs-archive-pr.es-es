...
---
# <a name="summary-configuring-permissions-on-database-objects"></a>Resumen: Configuración de permisos en objetos de base de datos
...
## <a name="next-lesson-in-tutorial"></a>Siguiente lección del tutorial  
