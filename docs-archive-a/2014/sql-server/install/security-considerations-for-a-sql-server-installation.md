...
-   [Instalar SQL Server en un controlador de dominio](../../../2014/sql-server/install/security-considerations-for-a-sql-server-installation.md#Install_DC)  
