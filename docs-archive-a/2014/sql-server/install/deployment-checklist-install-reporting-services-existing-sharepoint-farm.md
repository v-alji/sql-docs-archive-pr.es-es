...
|(Opcional) Buscar el nombre de la puerta de enlace o el servidor SMTP que proporciona el servicio de correo electrónico a la organización si se va a usar el correo electrónico del servidor de informes en las suscripciones|[Configurar un servidor de informes para la entrega por correo electrónico &#40;SSRS Configuration Manager&#41;](../../../2014/sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md)|  
...
|Instale el complemento de SharePoint en todos los equipos front-end web (WFE).|[Agregar un front-end web adicional de Reporting Services a una granja de servidores](../../reporting-services/install-windows/add-an-additional-reporting-services-web-front-end-to-a-farm.md)|  
...
|Aprovisionar el Agente SQL Server|[Aprovisionar Subscripciones y alertas para aplicaciones de servicio SSRS](../../reporting-services/install-windows/provision-subscriptions-and-alerts-for-ssrs-service-applications.md)|  
