...
```  
 ...
 El siguiente código de [!INCLUDE[tsql](../../includes/tsql-md.md)] quita el ensamblado, el inicio de sesión, la clave y los procedimientos almacenados de la base de datos.  
