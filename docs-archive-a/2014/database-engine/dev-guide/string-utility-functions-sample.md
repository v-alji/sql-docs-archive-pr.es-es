...
ms.locfileid: "87746470"
---
# <a name="string-utility-functions-sample"></a><span data-ttu-id="7a2b5-102">Ejemplo de funciones de la utilidad String</span><span class="sxs-lookup"><span data-stu-id="7a2b5-102">String Utility Functions Sample</span></span>
  <span data-ttu-id="7a2b5-103">El ejemplo de funciones de la utilidad String contiene una función con valores de tabla de transmisión de datos, escrita en Visual C# y Visual Basic, que divide una cadena delimitada por comas en una tabla con una columna.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-103">The String Utilities sample contains a streaming table-valued function written in Visual C# and Visual Basic, which splits a comma-separated string into a table with one column.</span></span> <span data-ttu-id="7a2b5-104">También contiene una función de agregado que convierte una columna de cadenas en una cadena delimitada por comas.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-104">It also contains an aggregate function that converts a string column to a comma-separated string.</span></span>  <span data-ttu-id="7a2b5-105">Además, se implementan una función escalar y una función con valores de tabla que permiten reemplazar y buscar expresiones regulares.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-105">Also implemented are a scalar function and a table-valued function that provide regular expression replacement and regular expression searching functionality.</span></span>  
  
 <span data-ttu-id="7a2b5-106">Para implementar una función con valores de tabla de transmisión de datos, cree un método que devuelva un objeto que implemente la interfaz `IEnumerable`.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-106">To implement a streaming table-valued function, create a method that returns an object that implements the `IEnumerable` interface.</span></span> <span data-ttu-id="7a2b5-107">Este método de `IEnumerable` debe estar vinculado mediante un atributo a otro método que rellene las filas de la función con valores de tabla.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-107">This `IEnumerable` method must be linked by an attribute to another method which fills in rows of the table-valued function.</span></span>  
  
## <a name="prerequisites"></a><span data-ttu-id="7a2b5-108">Requisitos previos</span><span class="sxs-lookup"><span data-stu-id="7a2b5-108">Prerequisites</span></span>  
 <span data-ttu-id="7a2b5-109">Para crear y ejecutar este proyecto se debe instalar el siguiente software:</span><span class="sxs-lookup"><span data-stu-id="7a2b5-109">To create and run this project the following the following software must be installed:</span></span>  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] <span data-ttu-id="7a2b5-110">o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-110">or [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express.</span></span> <span data-ttu-id="7a2b5-111">Puede obtener [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express de forma gratuita desde el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sitio web [de documentación y ejemplos de](https://www.microsoft.com/download/details.aspx?id=42299)Express.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-111">You can obtain [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express free of charge from the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express Documentation and Samples [Web site](https://www.microsoft.com/download/details.aspx?id=42299)</span></span>  
  
-   <span data-ttu-id="7a2b5-112">La base de datos de AdventureWorks que está disponible en el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sitio web [para desarrolladores de](https://archive.codeplex.com/?p=SqlServerSamples).</span><span class="sxs-lookup"><span data-stu-id="7a2b5-112">The AdventureWorks database that is available at the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Developer [Web site](https://archive.codeplex.com/?p=SqlServerSamples)</span></span>  
  
-   <span data-ttu-id="7a2b5-113">.NET Framework SDK 2.0 o posterior, o Microsoft Visual Studio 2005 o posterior.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-113">.NET Framework SDK 2.0 or later or Microsoft Visual Studio 2005 or later.</span></span> <span data-ttu-id="7a2b5-114">Puede obtener .NET Framework SDK de forma gratuita.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-114">You can obtain .NET Framework SDK free of charge.</span></span>  
  
-   <span data-ttu-id="7a2b5-115">Además, se deben cumplir las siguientes condiciones:</span><span class="sxs-lookup"><span data-stu-id="7a2b5-115">In addition, the following conditions must be met:</span></span>  
  
-   <span data-ttu-id="7a2b5-116">La instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que está usando debe tener habilitada la integración con CLR.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-116">The [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using must have CLR integration enabled.</span></span>  
  
-   <span data-ttu-id="7a2b5-117">Para habilitar la integración con CLR, siga estos pasos:</span><span class="sxs-lookup"><span data-stu-id="7a2b5-117">In order to enable CLR integration, perform the following steps:</span></span>  
  
    #### <a name="enabling-clr-integration"></a><span data-ttu-id="7a2b5-118">Habilitar la integración con CLR</span><span class="sxs-lookup"><span data-stu-id="7a2b5-118">Enabling CLR Integration</span></span>  
  
    -   <span data-ttu-id="7a2b5-119">Ejecute los siguientes comandos [!INCLUDE[tsql](../../includes/tsql-md.md)] :</span><span class="sxs-lookup"><span data-stu-id="7a2b5-119">Execute the following [!INCLUDE[tsql](../../includes/tsql-md.md)] commands:</span></span>  
    ...
    > [!NOTE]  
    >  <span data-ttu-id="7a2b5-120">Para habilitar la integración CLR, debe tener el permiso de nivel de servidor `ALTER SETTINGS`, que se concede implícitamente a los miembros de los roles fijos de servidor `sysadmin` y `serveradmin`.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-120">To enable CLR integration, you must have `ALTER SETTINGS` server level permission, which is implicitly held by members of the `sysadmin` and `serveradmin` fixed server roles.</span></span>  
  
-   <span data-ttu-id="7a2b5-121">La base de datos de AdventureWorks debe estar instalada en la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que está usando.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-121">The AdventureWorks database must be installed on the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using.</span></span>  
  
-   <span data-ttu-id="7a2b5-122">Si no es administrador de la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que está usando, debe hacer que un administrador le conceda el permiso **CreateAssembly** para completar la instalación.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-122">If you are not an administrator for the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using, you must have an administrator grant you **CreateAssembly**  permission to complete the installation.</span></span>  
  
## <a name="building-the-sample"></a><span data-ttu-id="7a2b5-123">Generar el ejemplo</span><span class="sxs-lookup"><span data-stu-id="7a2b5-123">Building the Sample</span></span>  
  
#### <a name="create-and-run-the-sample-by-using-the-following-instructions"></a><span data-ttu-id="7a2b5-124">Cree y ejecute el ejemplo utilizando las siguientes instrucciones:</span><span class="sxs-lookup"><span data-stu-id="7a2b5-124">Create and run the sample by using the following instructions:</span></span>  
  
1.  <span data-ttu-id="7a2b5-125">Abra un símbolo del sistema de Visual Studio o de .NET Framework.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-125">Open a Visual Studio or .NET Framework command prompt.</span></span>  
  
2.  <span data-ttu-id="7a2b5-126">Si es necesario, cree un directorio para el ejemplo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-126">If necessary, create a directory for your sample.</span></span> <span data-ttu-id="7a2b5-127">Para este ejemplo, utilizaremos C:\MySample.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-127">For this example, we will use C:\MySample.</span></span>  
  
3.  <span data-ttu-id="7a2b5-128">En c:\MySample, cree `StringUtils.vb` (para el ejemplo de Visual Basic) o `StringUtils.cs` (para el ejemplo de C#) y copie el código muestra de Visual Basic o de C# que corresponda (más abajo) en el archivo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-128">In c:\MySample, create `StringUtils.vb` (for the Visual Basic sample) or `StringUtils.cs` (for the C# sample) and copy the appropriate Visual Basic or C# sample code (below) into the file.</span></span>  
  
4.  <span data-ttu-id="7a2b5-129">Compile el código muestra desde el símbolo del sistema ejecutando uno de los comandos siguientes, dependiendo de su opción de lenguaje.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-129">Compile the sample code from the command line prompt by executing one of the following, depending on your choice of language.</span></span>  
...
5.  <span data-ttu-id="7a2b5-130">Copie el código de instalación de [!INCLUDE[tsql](../../includes/tsql-md.md)] en un archivo y guárdelo como `Install.sql` en el directorio de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-130">Copy the [!INCLUDE[tsql](../../includes/tsql-md.md)] installation code into a file and save it as `Install.sql` in the sample directory.</span></span>  
  
6.  <span data-ttu-id="7a2b5-131">Si el ejemplo está instalado en un directorio distinto de `C:\MySample\`, edite el archivo `Install.sql` del archivo como se indica para señalar esa ubicación.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-131">If the sample is installed in a directory other then `C:\MySample\`, edit the file `Install.sql` as indicated to point to that location.</span></span>  
  
7.  <span data-ttu-id="7a2b5-132">Implemente el ensamblado y el procedimiento almacenado ejecutando</span><span class="sxs-lookup"><span data-stu-id="7a2b5-132">Deploy the assembly and stored procedure by executing</span></span>  
  
    -   `sqlcmd -E -I -i install.sql`  
  
    -   <span data-ttu-id="7a2b5-133">Copie el script de comando de prueba de [!INCLUDE[tsql](../../includes/tsql-md.md)] en un archivo y guárdelo como `test.sql` en el directorio de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-133">Copy [!INCLUDE[tsql](../../includes/tsql-md.md)] test command script into a file and save it as `test.sql` in the sample directory.</span></span>  
  
8.  <span data-ttu-id="7a2b5-134">Ejecute el script de prueba con el siguiente comando</span><span class="sxs-lookup"><span data-stu-id="7a2b5-134">Execute the test script with the following command</span></span>  
  
    -   `sqlcmd -E -I -i test.sql`  
  
9. <span data-ttu-id="7a2b5-135">Copie el script de limpieza de [!INCLUDE[tsql](../../includes/tsql-md.md)] en un archivo y guárdelo como `cleanup.sql` en el directorio de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-135">Copy the [!INCLUDE[tsql](../../includes/tsql-md.md)] cleanup script into a file and save it as `cleanup.sql` in the sample directory.</span></span>  
  
10. <span data-ttu-id="7a2b5-136">Ejecute el script con el siguiente comando</span><span class="sxs-lookup"><span data-stu-id="7a2b5-136">Execute the script with the  following command</span></span>  
  
    -   `sqlcmd -E -I -i cleanup.sql`  
  
  
## <a name="sample-code"></a><span data-ttu-id="7a2b5-137">Código de ejemplo</span><span class="sxs-lookup"><span data-stu-id="7a2b5-137">Sample Code</span></span>  
 <span data-ttu-id="7a2b5-138">A continuación se muestran las listas de código para este ejemplo.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-138">The following are the code listings for this sample.</span></span>  
  
 <span data-ttu-id="7a2b5-139">C#</span><span class="sxs-lookup"><span data-stu-id="7a2b5-139">C#</span></span>  
...
```  
 ...
 <span data-ttu-id="7a2b5-140">VB.NET</span><span class="sxs-lookup"><span data-stu-id="7a2b5-140">VB.NET</span></span>  
...
```  
 ...
 <span data-ttu-id="7a2b5-141">Este es el script de instalación de [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`), que implementa el ensamblado y crea el procedimiento almacenado en la base de datos.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-141">This is the [!INCLUDE[tsql](../../includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assembly and creates the stored procedure in the database.</span></span>  
...
```  
 ...
 <span data-ttu-id="7a2b5-142">Este es el script `test.sql`que prueba el ejemplo ejecutando las funciones.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-142">This is `test.sql`, which tests the sample by executing the functions.</span></span>  
...
```  
 ...
 <span data-ttu-id="7a2b5-143">El siguiente script [!INCLUDE[tsql](../../includes/tsql-md.md)] quita de la base de datos el ensamblado y las funciones.</span><span class="sxs-lookup"><span data-stu-id="7a2b5-143">The following [!INCLUDE[tsql](../../includes/tsql-md.md)] removes the assembly and functions from the database.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="7a2b5-144">Consulte también</span><span class="sxs-lookup"><span data-stu-id="7a2b5-144">See Also</span></span>  
 [<span data-ttu-id="7a2b5-145">Escenarios de uso y ejemplos para la integración de Common Language Runtime &#40;CLR&#41;</span><span class="sxs-lookup"><span data-stu-id="7a2b5-145">Usage Scenarios and Examples for Common Language Runtime &#40;CLR&#41; Integration</span></span>](../../../2014/database-engine/dev-guide/usage-scenarios-and-examples-for-common-language-runtime-clr-integration.md)  
