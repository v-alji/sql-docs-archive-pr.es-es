...
---
# <a name="sql-server-native-client-odbc-reference"></a>Referencia de SQL Server Native Client (ODBC)
...
-   [Extensiones del controlador de SQL Server](../../../2014/database-engine/dev-guide/sql-server-driver-extensions.md)  
