...
-   [Errores y eventos del proveedor WMI](../../relational-databases/native-client-ole-db-errors/errors.md)  
  
-   [Proveedor WMI para las clases de administración de configuración](../../relational-databases/wmi-provider-configuration-classes/wmi-provider-for-configuration-management-classes.md)  
