...
3.  En c:\MySample, cree `Contacts.vb` (para el ejemplo de Visual Basic) o `Contacts.cs` (para el ejemplo de C#) y copie el código muestra de Visual Basic o de C# que corresponda (más abajo) en el archivo.  
...
```  
 ...
 El siguiente script [!INCLUDE[tsql](../../includes/tsql-md.md)] quita el ensamblado, el procedimiento almacenado y los datos insertados de la base de datos.  
