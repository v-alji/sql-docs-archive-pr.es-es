...
```  
 ...
 Es el código para probar la biblioteca `ResultSet.`  
...
```  
 ...
 Este es el script de instalación de [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`), que implementa los ensamblados y crea los procedimientos almacenados.  
...
```  
 ...
 El script [!INCLUDE[tsql](../../includes/tsql-md.md)] siguiente quita los ensamblados y los procedimientos almacenados de la base de datos.  
