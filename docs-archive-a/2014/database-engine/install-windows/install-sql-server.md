...
|[Instalar Replicación de SQL Server](install-sql-server-replication.md)|Describe cómo instalar y configurar la replicación de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .|  
...
## <a name="how-to-install-sscurrent"></a>Cómo instalar[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
