 ...
 **Mostrar glifos visuales para ajuste de línea**  
 Muestra un indicador de retorno de carro donde una línea larga se haya ajustado a una segunda línea. Desactive esta casilla si no desea ver estos indicadores.  
 ...
 **Números de línea**  
 Muestra un número de línea junto a cada línea de texto.  
