...
-   Es posible que el servicio Explorador de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] no se esté ejecutando en el equipo en el que se ejecuta [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].  
