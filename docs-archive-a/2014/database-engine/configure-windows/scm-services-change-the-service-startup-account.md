...
4.  En el cuadro de diálogo **Propiedades de \<***instancename***> de SQL Server** haga clic en la pestaña **Iniciar sesión** y seleccione un tipo de cuenta **Iniciar sesión como**.  
