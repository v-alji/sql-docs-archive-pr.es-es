...
3.  En el panel de detalles, haga clic con el botón derecho en **SQL Server (\<***instancename***>)** y, después, en **Propiedades**.  
  
4.  En el cuadro de diálogo **Propiedades de SQL Server (\<***instancename***>)** , cambie las propiedades en la pestaña **Servicio** o **Avanzado** y, después, haga clic en **Aceptar**.  
  
##  <a name="follow-up-after-you-change-server-properties"></a><a name="FollowUp"></a>Seguimiento: después de cambiar las propiedades del servidor  
