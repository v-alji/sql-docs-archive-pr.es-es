...
-   [Ver o cambiar las propiedades del servidor &#40;SQL Server&#41;](view-or-change-server-properties-sql-server.md)  
...
> [!NOTE]  
>  La opción de actualización de texto completo también se puede establecer con la acción [sp_fulltext_service](/sql/relational-databases/system-stored-procedures/sp-fulltext-service-transact-sql)upgrade_option.  
