...
##  <a name="database-engine-feature-enhancements"></a><a name="Feature"></a>Mejoras en las características de Motor de base de datos  
  
###  <a name="memory-optimized-tables"></a><a name="MemoryOpt"></a>Tablas con optimización para memoria  
...
###  <a name="new-design-for-cardinality-estimation"></a><a name="CE"></a>Nuevo diseño para la estimación de la cardinalidad  
...
###  <a name="delayed-durability"></a><a name="Durability"></a>Durabilidad diferida  
...
###  <a name="alwayson-enhancements"></a><a name="AlwaysOn"></a>Mejoras de AlwaysOn  
...
###  <a name="partition-switching-and-indexing"></a><a name="OIR"></a>Conmutación e indización de particiones  
...
###  <a name="managing-the-lock-priority-of-online-operations"></a><a name="Lock"></a>Administrar la prioridad de bloqueo de las operaciones en línea  
...
###  <a name="columnstore-indexes"></a><a name="CCI"></a>Índices de almacén de columnas  
...
###  <a name="buffer-pool-extension"></a><a name="Buffer"></a>Extensión del grupo de búferes  
...
###  <a name="incremental-statistics"></a><a name="Stats"></a>Estadísticas incrementales  
...
###  <a name="resource-governor-enhancements-for-physical-io-control"></a><a name="RG"></a>Resource Governor mejoras para el control físico de e/s  
...
###  <a name="online-index-operation-event-class"></a><a name="OnlineEvent"></a>Online index Operation (clase de eventos)  
...
###  <a name="database-compatibility-level"></a><a name="Compat"></a>Nivel de compatibilidad de bases de datos  
...
##  <a name="transact-sql-enhancements"></a><a name="TSQL"></a>Mejoras de Transact-SQL  
...
### <a name="tsql-enhancements-for-in-memory-oltp"></a>Mejoras de [!INCLUDE[tsql](../includes/tsql-md.md)] para OLTP en memoria  
