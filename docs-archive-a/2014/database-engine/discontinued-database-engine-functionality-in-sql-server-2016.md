...
|Category|Característica no incluida|Replacement|  
|--------------|--------------------------|-----------------|  
...
|Seguridad|El parámetro de versión de **PWDCOMPARE** que representa un valor de un inicio de sesión anterior a [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 2000 es discontinuo.|None|  
