...
7.  Confirme que la conmutación por error se realizó correctamente:  
    ...
    -   Vea el panel para determinar si se ha detectado algún problema de mantenimiento. Haga clic con el botón derecho en el grupo de disponibilidad y seleccione **Mostrar panel**.  
