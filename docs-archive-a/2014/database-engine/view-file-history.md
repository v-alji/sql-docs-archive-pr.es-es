...
5.  Vea los detalles concretos sobre la versión seleccionada.  
  
6.  Recupere una copia de la versión seleccionada en el disco local.  
  
7.  Vea las diferencias entre la versión seleccionada y la versión almacenada localmente.  
  
8.  Identifique una versión concreta de un archivo como versión actual.  
