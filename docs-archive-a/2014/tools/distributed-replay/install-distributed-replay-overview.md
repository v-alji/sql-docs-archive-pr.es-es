...
|[Desinstalar una instancia existente de Distributed Replay](../../sql-server/install/uninstall-an-existing-instance-of-distributed-replay.md)|Tema de procedimientos para desinstalar una instancia existente de Distributed Replay.|  
