...
-   Seleccionar el origen de datos de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] desde el que desea vincular o importar los objetos.  
  
-   Seleccionar los objetos que desea vincular o importar.  
