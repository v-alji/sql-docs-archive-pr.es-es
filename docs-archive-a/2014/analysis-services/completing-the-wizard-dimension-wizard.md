...
-   Asignar un nombre a la dimensión.  
  
-   Revisar los cambios que se realizarán cuando se hace clic en **Finalizar** .  
 ...
 **Generar el esquema ahora**  
 Seleccione esta opción para generar el esquema necesario para admitir la dimensión. Si la selecciona, se abrirá el Asistente para generar esquemas.  
