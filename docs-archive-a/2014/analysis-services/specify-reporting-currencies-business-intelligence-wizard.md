 ...
 **Monedas del informe**  
 Seleccione **Monedas del informe** para incluir todos los miembros enumerados de la dimensión de moneda en la dimensión de moneda del informe. Desactive **Monedas del informe** para excluir todos los miembros enumerados.  
