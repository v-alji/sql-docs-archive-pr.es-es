 ...
 **Progreso**  
 Muestra el progreso del asistente a medida que se importa cada objeto de la base de datos al proyecto de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .  
