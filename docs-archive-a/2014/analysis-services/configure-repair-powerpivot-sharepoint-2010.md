...
||Passphrase|Entrada de usuario|Si va a crear una nueva granja, la frase de contraseña que escriba será la frase de contraseña para la granja. Si va a agregar PowerPivot para SharePoint a una granja existente, debe proporcionar la frase de contraseña que se definió para la granja cuando se creó.|
