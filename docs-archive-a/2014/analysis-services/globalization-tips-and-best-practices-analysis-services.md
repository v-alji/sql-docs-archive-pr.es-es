...
##  <a name="use-similar-collations-throughout-the-stack"></a><a name="bkmk_sameColl"></a>Usar intercalaciones similares en toda la pila  
...
##  <a name="common-collation-recommendations"></a><a name="bkmk_recos"></a> Recomendaciones de intercalación comunes  
...
##  <a name="case-sensitivity-of-object-identifiers"></a><a name="bkmk_objid"></a> Distinción entre mayúsculas y minúsculas de los identificadores de objetos  
...
##  <a name="locale-testing-using-excel-sql-server-profiler-and-sql-server-management-studio"></a><a name="bkmk_test"></a> Pruebas de configuración regional con Excel, SQL Server Profiler y SQL Server Management Studio  
...
##  <a name="writing-mdx-queries-in-a-solution-containing-translations"></a><a name="bkmk_mdx"></a> Escritura de consultas MDX en una solución que contiene traducciones  
...
##  <a name="writing-mdx-queries-containing-date-and-time-values"></a><a name="bkmk_datetime"></a> Escritura de consultas MDX que contengan valores de fecha y hora  
