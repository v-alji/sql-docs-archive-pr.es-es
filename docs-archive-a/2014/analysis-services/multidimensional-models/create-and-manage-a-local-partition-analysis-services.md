...
5.  En la cláusula WHERE de la parte inferior, agregue un filtro que segmente los datos para esta partición.
     ...
     Algunos ejemplos de sintaxis de la cláusula WHERE incluyen `WHERE OrderDateKey >= '20060101'` o `WHERE OrderDateKey BETWEEN '20051001' AND '20051201'`. Para obtener otros ejemplos, vea [WHERE &#40;Transact-SQL&#41;](/sql/t-sql/queries/where-transact-sql).
...
1.  Cree una o varias consultas con nombre para usar como origen de la partición. Para más información, vea [Definir consultas con nombre en una vista del origen de datos &#40;Analysis Services&#41;](define-named-queries-in-a-data-source-view-analysis-services.md).
