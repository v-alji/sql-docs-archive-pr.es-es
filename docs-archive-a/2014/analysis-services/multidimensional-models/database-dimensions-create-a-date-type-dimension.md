...
### <a name="calendars"></a>Calendarios  
 ...
 Las aplicaciones de Business Intelligence necesitan a menudo varias definiciones de calendarios. Por ejemplo, un departamento de recursos humanos puede realizar un seguimiento de los empleados mediante un calendario *estándar* : un calendario gregoriano de doce meses que empieza el 1 de enero y termina el 31 de diciembre. Sin embargo, ese mismo Departamento de recursos humanos puede realizar un seguimiento de los gastos mediante un calendario *fiscal* : un calendario de doce meses que define el año fiscal que usa la organización.  
...
|Calendario de informes (o calendario de marketing)|Calendario de informes de doce meses que incluye dos meses de cuatro semanas y un mes de cinco semanas en un patrón trimestral que se repite. Al seleccionar este calendario, especifique el día y el mes de inicio y el patrón de tres meses de 4-4-5, 4-5-4 o 5-4-4 semanas, donde cada dígito representa el número de semanas de un mes.<br /><br /> Nota: Este calendario solo está disponible si se utiliza el Asistente para dimensiones para crear una dimensión temporal del servidor.|  
