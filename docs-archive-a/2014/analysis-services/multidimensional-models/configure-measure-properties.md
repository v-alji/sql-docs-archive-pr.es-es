...
|--------------|----------------|  
|`AggregateFunction`|Obligatorio. Determina cómo se agregan las medidas. `Sum` es la agregación predeterminada. Para más información, vea [Use Aggregate Functions](use-aggregate-functions.md) para obtener una descripción de cada función.|  
...
|`ID`|Necesario. Muestra el identificador único (Id.) de la medida. Esta propiedad es de sólo lectura.|  
