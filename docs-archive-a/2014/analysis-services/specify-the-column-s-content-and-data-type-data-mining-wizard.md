 ...
 **Columnas**  
 Lista de las columnas definidas en la página **Especificar los datos de aprendizaje** del asistente.  
  
 **Tipo de contenido**  
 El tipo de contenido que se asigna a cada columna. Haga clic dentro de una celda para cambiar el tipo de contenido. Para obtener más información sobre los tipos de contenido, vea [Tipos de contenido &#40;minería de datos&#41;](data-mining/content-types-data-mining.md).  
