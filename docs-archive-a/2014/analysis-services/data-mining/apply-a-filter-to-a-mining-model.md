...
1.  Agregue más condiciones según sea necesario; para ello, seleccione `AND` o `OR` en el cuadro **y/o** en el lado izquierdo de la cuadrícula de **condiciones** . [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
