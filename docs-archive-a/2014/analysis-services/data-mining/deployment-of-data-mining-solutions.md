...
-   Utilice los modelos para crear predicciones y tomar decisiones empresariales. Para obtener información acerca de las herramientas que puede utilizar para crear consultas, vea [interfaces de consulta de minería de datos](data-mining-query-tools.md).  
