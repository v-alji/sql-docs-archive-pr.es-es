...
##  <a name="overview-of-process"></a><a name="BKMK_Relational_Structure"></a>Información general del proceso  
...
##  <a name="how-to-choose-relational-data"></a><a name="BKMK_ChooseRelData"></a>Cómo elegir datos relacionales  
 ...
 Si las tablas incluyen cualquier relación de uno a varios; por ejemplo, tiene varios registros de compra para cada cliente que desea analizar: puede Agregar ambas tablas y, a continuación, utilizar una tabla como tabla de casos, vinculando los datos del lado de varios de la relación como una tabla anidada.  
...
##  <a name="how-to-specify-content-type-and-data-type"></a><a name="bkmk_ContentDataType"></a>Cómo especificar el tipo de contenido y el tipo de datos  
...
##  <a name="why-and-how-to-split-data-into-training-and-testing-sets"></a><a name="bkmk_Holdout"></a>Por qué y cómo dividir los datos en conjuntos de entrenamiento y de prueba  
...
##  <a name="why-and-how-to-enable-drillthrough"></a><a name="BKMK_DrillThru"></a>Por qué y cómo habilitar la obtención de detalles  
