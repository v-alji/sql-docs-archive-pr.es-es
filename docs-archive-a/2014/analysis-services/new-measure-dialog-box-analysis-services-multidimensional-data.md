...
-   Hacer clic en **Nueva medida** en el panel **Barra de herramientas** de la pestaña **Estructura de cubo** en el Diseñador de cubos.  
 ...
 **Tabla de origen**  
 Permite seleccionar la tabla desde la que se creará la nueva medida.  
  
 **Columna de origen**  
 En la tabla seleccionada en **Tabla de origen** , permite seleccionar la columna en la que se basará la nueva medida.  
