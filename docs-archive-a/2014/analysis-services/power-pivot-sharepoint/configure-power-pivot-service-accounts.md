...
##  <a name="troubleshooting-grant-administrative-permissions-manually"></a><a name="updatemanually"></a>Solución de problemas: conceder permisos administrativos manualmente  
