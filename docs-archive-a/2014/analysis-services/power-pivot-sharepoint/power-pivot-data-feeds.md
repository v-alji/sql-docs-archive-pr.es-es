...
## <a name="related-tasks"></a>Related Tasks  
 [Crear o personalizar una biblioteca de fuentes de distribución de datos &#40;PowerPivot para SharePoint&#41;](create-or-customize-a-data-feed-library-power-pivot-for-sharepoint.md)  
  
 [Eliminar una biblioteca de fuente de distribución de datos PowerPivot](delete-a-power-pivot-data-feed-library.md)  
