...
##  <a name="icons-in-powerpivot-gallery"></a><a name="icons"></a>Iconos de la galería de PowerPivot
...
##  <a name="save-an-excel-workbook-to-powerpivot-gallery"></a><a name="add"></a>Guardar un libro de Excel en la galería de PowerPivot
...
##  <a name="create-new-reports-or-workbooks-based-on-a-published-powerpivot-workbook"></a><a name="newdocs"></a>Crear nuevos informes o libros basados en un libro PowerPivot publicado
...
##  <a name="open-a-workbook-or-report-in-full-page-mode"></a><a name="view"></a>Abrir un libro o informe en modo de página completa
...
##  <a name="schedule-data-refresh-for-powerpivot-workbooks-in-powerpivot-gallery"></a><a name="newdr"></a>Programar la actualización de datos para los libros PowerPivot en la galería de PowerPivot
...
##  <a name="delete-a-workbook-or-report-in-powerpivot-gallery"></a><a name="delete"></a>Eliminar un libro o informe en la galería de PowerPivot
...
##  <a name="refresh-a-thumbnail-image"></a><a name="image"></a>Actualizar una imagen en miniatura
