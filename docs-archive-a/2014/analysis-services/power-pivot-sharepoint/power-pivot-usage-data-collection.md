...
##  <a name="usage-data-collection-and-reporting-architecture"></a><a name="usagearch"></a> Recopilación de datos de uso y arquitectura de los informes  
...
##  <a name="sources-of-usage-data"></a><a name="sources"></a> Orígenes de datos de uso  
...
##  <a name="services-and-timer-jobs"></a><a name="servicesjobs"></a> Servicios y trabajos del temporizador  
...
##  <a name="reporting-on-usage-data"></a><a name="reporting"></a> Informes sobre los datos de uso  
