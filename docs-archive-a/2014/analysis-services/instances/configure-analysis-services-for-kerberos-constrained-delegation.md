...
##  <a name="allow-analysis-services-to-impersonate-a-user-identity"></a><a name="bkmk_impersonate"></a>Permitir que Analysis Services suplante una identidad de usuario  
...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a>Configurar Analysis Services para la delegación de confianza  
...
##  <a name="test-for-impersonated-or-delegated-identity"></a><a name="bkmk_test"></a>Prueba de la identidad suplantada o delegada  
