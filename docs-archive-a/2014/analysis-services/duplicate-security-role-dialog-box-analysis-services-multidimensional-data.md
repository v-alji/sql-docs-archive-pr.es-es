...
|Término|Definición|  
|----------|----------------|  
|**Nuevo nombre de rol**|Escriba el nombre del nuevo rol que se creará con los mismos miembros y permisos que los del rol seleccionado en el Explorador de objetos.|  
