...
-   Seleccionar la base de datos y la instancia de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] desde la que se generará el proyecto de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .  
