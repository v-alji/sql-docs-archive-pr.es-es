...
|**Desconexión**|Desconecta el Editor de consultas DMX de una instancia de [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .|  
...
|**Parse**|Comprueba la sintaxis del código seleccionado. Si no se selecciona ningún código, esta opción comprueba la sintaxis de toda la ventana del Editor de consultas DMX.|  
