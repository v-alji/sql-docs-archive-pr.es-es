...
ms.locfileid: "87669881"
---
# <a name="hierarchy-representation-tabular"></a><span data-ttu-id="35ebd-102">Representación de jerarquía (tabular)</span><span class="sxs-lookup"><span data-stu-id="35ebd-102">Hierarchy Representation (Tabular)</span></span>
  <span data-ttu-id="35ebd-103">En los modelos tabulares, una jerarquía es una ruta de navegación entre un atributo y otro en función de los valores seleccionados por el usuario.</span><span class="sxs-lookup"><span data-stu-id="35ebd-103">In tabular models a hierarchy is navigation path from one attribute to another based on values selected by the user.</span></span>  
  
## <a name="hierarchy-representation"></a><span data-ttu-id="35ebd-104">Representación de jerarquía</span><span class="sxs-lookup"><span data-stu-id="35ebd-104">Hierarchy Representation</span></span>  
  
### <a name="hierarchy-in-amo"></a><span data-ttu-id="35ebd-105">Jerarquía en AMO</span><span class="sxs-lookup"><span data-stu-id="35ebd-105">Hierarchy in AMO</span></span>  
 <span data-ttu-id="35ebd-106">Cuando se usa AMO para administrar una tabla del modelo tabular, hay una correspondencia uno a uno entre el objeto y jerarquía en AMO.</span><span class="sxs-lookup"><span data-stu-id="35ebd-106">When using AMO to manage a tabular model table, there is a one-to-one object match for a hierarchy in AMO.</span></span> <span data-ttu-id="35ebd-107">Una jerarquía se representa mediante el objeto <xref:Microsoft.AnalysisServices.Hierarchy>.</span><span class="sxs-lookup"><span data-stu-id="35ebd-107">A hierarchy is represented by the <xref:Microsoft.AnalysisServices.Hierarchy> object.</span></span>  
  
 <span data-ttu-id="35ebd-108">En el fragmento de código siguiente se muestra cómo se agrega una jerarquía en un modelo tabular existente.</span><span class="sxs-lookup"><span data-stu-id="35ebd-108">The following code snippet shows how to add a hierarchy to an existing tabular model.</span></span> <span data-ttu-id="35ebd-109">En el código se presupone que tiene un objeto de base de datos de AMO, newDatabase, y un objeto de cubo de AMO, modelCube.</span><span class="sxs-lookup"><span data-stu-id="35ebd-109">The code assumes you have an AMO database object, newDatabase, and an AMO cube object, modelCube.</span></span>  
