...
-   Guardar y, opcionalmente, procesar la partición, el grupo de medida o el cubo para generar las agregaciones definidas.  
 ...
 Después de utilizar el Asistente para diseñar agregaciones, puede utilizar el Asistente para optimización basada en el uso para diseñar agregaciones basadas en patrones de uso de los usuarios empresariales y las aplicaciones cliente que consultan el cubo.  
