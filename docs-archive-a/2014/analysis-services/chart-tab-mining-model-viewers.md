 ...
 **Ajustar diagrama a la ventana**  
 Aleje el gráfico hasta que se ajuste completo en la pantalla.  
 ...
 **Mostrar desviaciones**  
 Seleccione esta opción para agregar barras de error al gráfico. Las barras de error representan la varianza de las predicciones y, por consiguiente, solo aparecen en los valores de predicción.  
  
 **Pasos de predicción**  
 Elija cuántos pasos temporales futuros desea ver en el visor.  
