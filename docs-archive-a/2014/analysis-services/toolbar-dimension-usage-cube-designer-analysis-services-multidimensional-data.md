...
|**Orden descendente**|Haga clic en esta opción para ordenar las filas y las columnas del panel **Cuadrícula** en orden descendente.|  
|**Eliminar selección**|Haga clic en esta opción para mostrar el cuadro de diálogo **Eliminar objetos** y eliminar los objetos seleccionados en el panel **Cuadrícula** .|  
