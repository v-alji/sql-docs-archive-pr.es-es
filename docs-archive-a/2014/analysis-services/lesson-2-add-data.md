...
##  <a name="filter-the-table-data"></a><a name="FilterData"></a>Filtrar los datos de la tabla  
...
##  <a name="import-the-selected-tables-and-column-data"></a><a name="Import"></a>Importar las tablas y los datos de columna seleccionados  
