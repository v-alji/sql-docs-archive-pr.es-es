 ...
 **Columnas**  
 Muestra los atributos y medidas disponibles. Todos los atributos deben estar en jerarquías o tener las jerarquías de atributo habilitadas.  
  
 **Entrada**  
 Seleccione esta opción para indicar si una medida o atributo se utilizará como columna de entrada en el modelo de minería de datos.  
