...
1.  Si la consulta está abierta en el Editor de consultas, haga clic con el botón derecho en una zona en blanco del editor, seleccione **Conexión**y, luego, haga clic en **Conectar**. Si la consulta no está abierta, haga doble clic en ella en el Explorador de soluciones para conectarla.  
