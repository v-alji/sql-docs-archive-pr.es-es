...
## <a name="benefits-of-templates"></a>Ventajas de las plantillas  
 ...
 El editor de consultas de [!INCLUDE[ssDE](../../includes/ssde-md.md)] también admite snippets de código que se pueden insertar en ubicaciones concretas de un script haciendo clic con el botón secundario en esa ubicación.  
