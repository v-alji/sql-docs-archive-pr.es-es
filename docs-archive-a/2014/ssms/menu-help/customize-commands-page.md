 ...
 **Comandos**  
 Muestra los comandos y las imágenes de los comandos en función de la categoría seleccionada. Es posible arrastrar un comando a una barra de herramientas que se desee personalizar.  
  
 **Modificar selección**  
 Muestra una lista de los comandos que pueden utilizarse para personalizar la presentación del botón en la barra de herramientas. Por ejemplo, puede cambiar la imagen o las teclas de método abreviado, así como especificar si debe mostrarse texto en lugar de una imagen para el comando. Este botón está disponible después de seleccionar un botón de comando de la barra de herramientas que desee personalizar.  
  
 **Reorganizar comandos**  
 Muestra el cuadro de diálogo **Reorganizar comandos** , en el que puede cambiar el nombre de los comandos de los menús y las barras de herramientas, reordenar, agregar y eliminar comandos, así como cambiar las imágenes de los botones y los comandos.  
