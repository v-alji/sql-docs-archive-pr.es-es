...
|Acción|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Contraer nodos de árbol|- (en el teclado numérico)|- (en el teclado numérico)|  
|Expandir todos los nodos de árbol|* (en el teclado numérico)|* (en el teclado numérico)|  
|Desplazarse por el control de árbol hacia arriba en la ventana|CTRL+FLECHA ARRIBA|CTRL+FLECHA ARRIBA|  
|Desplazarse por el control de árbol hacia abajo en la ventana|CTRL+FLECHA ABAJO|CTRL+FLECHA ABAJO|  
  
## <a name="code-editor-keyboard-shortcuts"></a>Métodos abreviados de teclado para el Editor de código  
...
## <a name="text-manipulation-in-code-editor-keyboard-shortcuts"></a>Métodos abreviados de teclado para manipular texto en el Editor de código  
...
|Activar o desactivar la opción **Buscar hacia atrás** de **Buscar y reemplazar**|ALT+F3, B|ALT+F3, B|  
