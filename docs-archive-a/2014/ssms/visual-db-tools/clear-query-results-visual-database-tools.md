...
> [!NOTE]  
>  Este operación no deshará los cambios que haya realizado en la base de datos. Para más información sobre cómo funciona el panel Resultados, consulte [Trabajar con datos en el panel Resultados &#40;Visual Database Tools&#41;](visual-database-tools.md).  
  
### <a name="to-clear-query-results-of-a-view"></a>Para borrar los resultados de consulta de una vista  
  
-   Haga clic con el botón derecho en el [panel Resultados](visual-database-tools.md), seleccione **Panel**y, luego, haga clic en **Borrar resultados**.  
