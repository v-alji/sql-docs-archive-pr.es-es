...
### <a name="to-remove-a-table-from-a-database-diagram"></a>Para quitar una tabla de un diagrama de base de datos  
  
1.  Seleccione en el diagrama de base de datos la tabla que desea quitar.  
...
2.  Haga clic con el botón derecho en la tabla y elija **Quitar tabla del diagrama** en el menú contextual.  
     ...
     Si la tabla tiene cambios sin guardar como consecuencia de las modificaciones realizadas en el diagrama de base de datos, un mensaje indica que se ha de guardar la tabla antes de quitarla.  
