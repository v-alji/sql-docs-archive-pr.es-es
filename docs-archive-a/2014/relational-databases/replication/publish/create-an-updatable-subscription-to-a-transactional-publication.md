...
1.  En la página **Opciones de suscripción**, del cuadro de diálogo **Propiedades de la publicación: \<Publication>** , seleccione uno de los valores siguientes para la opción **Directiva de resolución de conflictos**:    
