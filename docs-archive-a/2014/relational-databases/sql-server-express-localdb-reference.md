...
ms.locfileid: "87674046"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="793ac-102">Referencia de SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="793ac-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="793ac-103">Esta sección contiene información acerca de SQL Server Express LocalDB:</span><span class="sxs-lookup"><span data-stu-id="793ac-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="793ac-104">Referencia de mensajes de error de SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="793ac-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="793ac-105">Referencia de la API de instancia de SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="793ac-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="793ac-106">Ejemplo de código</span><span class="sxs-lookup"><span data-stu-id="793ac-106">Code Sample</span></span>  
 <span data-ttu-id="793ac-107">En el ejemplo siguiente se muestra el uso de la API LocalDB.</span><span class="sxs-lookup"><span data-stu-id="793ac-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="793ac-108">Asegúrese de que LocalDB esté instalado en el equipo antes de ejecutar este ejemplo:</span><span class="sxs-lookup"><span data-stu-id="793ac-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="793ac-109">Puede instalar LocalDB en la instalación en [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="793ac-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
