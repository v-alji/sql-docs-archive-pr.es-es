...
-   El mouse (ratón) y las teclas de navegación  
...
-   Haga clic en una ubicación para situar ahí el cursor.  
  
-   Utilice las barras de desplazamiento o la rueda de desplazamiento del mouse para moverse por el texto.  
  
-   Utilice las teclas INICIO, FIN, RE PÁG y AV PÁG para moverse por el texto.  
  
-   Utilice la combinación de teclas CTRL+RE PÁG y CTRL+AV PÁG para mover el punto de inserción al principio o al final de la ventana respectivamente.  
