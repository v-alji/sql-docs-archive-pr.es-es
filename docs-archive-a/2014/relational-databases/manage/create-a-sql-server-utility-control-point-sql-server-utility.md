...
## <a name="wizard-steps"></a>Pasos del asistente
 ...
 En las siguientes secciones se proporciona información sobre cada página del flujo de trabajo del asistente para crear un UCP nuevo de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Para iniciar el asistente a fin de crear un nuevo UCP, abra el panel Explorador de la utilidad en el menú Vista de SSMS y haga clic en el botón ![](../../database-engine/media/create-ucp.gif "Create_UCP") **Crear UCP** en la parte superior del panel Explorador de la utilidad.
...
## <a name="see-also"></a>Consulte también
 [Utilidad de SQL Server características y tareas](sql-server-utility-features-and-tasks.md) [solucionar el utilidad de SQL Server](../../database-engine/troubleshoot-the-sql-server-utility.md)
