...
-   *No se ha creado correctamente la firma de acceso compartido en el contenedor.*    
     Resolución: asegúrese de haber creado correctamente una firma de acceso compartido en el contenedor. Revise las instrucciones indicadas en la lección 2 en [Tutorial: SQL Server de archivos de datos en Azure Storage Service](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md).  
  
-   *La credencial de SQL Server no se ha creado correctamente.*    
    Resolución: asegúrese de que ha usado "Firma de acceso compartido" en el campo **Identidad** y que ha creado un secreto correctamente. Revise las instrucciones indicadas en la lección 3 de [Tutorial: SQL Server de archivos de datos en Azure Storage Service](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md).  
