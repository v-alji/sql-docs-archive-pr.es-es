 ...
 **Estado**  
 Muestra el estado de la base de datos. Para más información, consulte [Database States](database-states.md).  
 ...
 **Número de usuarios**  
 Muestra el número de usuarios conectados a la base de datos.  
