...
-   Cuando adjunte una base de datos replicada que fue copiada en lugar de separada:  
    ...
    -   Si se adjunta la base de datos a una versión actualizada de la misma instancia de servidor, es necesario ejecutar **sp_vupgrade_replication** para actualizar la replicación una vez finalizada la operación de adjuntar. Para obtener más información, vea [sp_vupgrade_replication &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-vupgrade-replication-transact-sql).  
...
3.  Adjunte los archivos copiados a la instancia de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Para obtener más información, consulte [Attach a Database](attach-a-database.md).  
