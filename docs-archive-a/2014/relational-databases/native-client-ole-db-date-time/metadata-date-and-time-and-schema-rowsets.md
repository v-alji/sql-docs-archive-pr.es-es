...
|BEST_MATCH|VARIANT_TRUE|VARIANT_TRUE|VARIANT_TRUE|VARIANT_TRUE a menos que se dé uno de los siguientes casos:<br /><br /> -Es el cliente conectado a un servidor de nivel inferior.<br />-La propiedad de conexión de compatibilidad de tipos de datos especifica un nivel de compatibilidad que es igual a 80.|VARIANT_TRUE a menos que se dé uno de los siguientes casos:<br /><br /> -Es el cliente conectado a un servidor de nivel inferior.<br />-La propiedad de conexión de compatibilidad de tipos de datos especifica un nivel de compatibilidad que es igual a 80.|VARIANT_TRUE|  
