...
##  <a name="create-a-workload-group-using-sql-server-management-studio"></a><a name="CreWGProp"></a> Crear un grupo de cargas de trabajo mediante SQL Server Management Studio  
...
##  <a name="create-a-workload-group-using-transact-sql"></a><a name="CreWGTSQL"></a> Crear un grupo de cargas de trabajo mediante Transact-SQL  
