...
##  <a name="configuring-a-fixed-port"></a><a name="port"></a>Configuración de un puerto fijo  
...
##  <a name="connecting-to-the-database-engine-from-another-computer"></a><a name="otherComp"></a>Conexión al Motor de base de datos desde otro equipo  
...
##  <a name="connecting-using-the-sql-server-browser-service"></a><a name="browser"></a>Conexión mediante el servicio de SQL Server Browser  
