...
## <a name="in-this-section"></a>En esta sección  
 [Programación de procedimientos almacenados extendidos](extended-stored-procedures-programming/database-engine-extended-stored-procedures-programming.md)  
 Explica cómo crear, administrar y usar procedimientos almacenados extendidos.  
 ...
 Contiene temas de referencia relativos a la API Procedimiento almacenado extendido.  
