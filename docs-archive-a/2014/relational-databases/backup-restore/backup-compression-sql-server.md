...
> [!NOTE]  
>  Para obtener información sobre las ediciones de que [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] admiten la compresión de copia de seguridad, vea [características compatibles con las ediciones de SQL Server 2014](../../getting-started/features-supported-by-the-editions-of-sql-server-2014.md). Cada edición de [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] y posteriores pueden restaurar una copia de seguridad cifrada.  
