...
> [!NOTE]  
>  Cuando se especifica una tarea de restauración mediante [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] , puede generar el [!INCLUDE[tsql](../../includes/tsql-md.md)] script [restore](/sql/t-sql/statements/restore-statements-transact-sql) correspondiente si hace clic en **script** y, a continuación, selecciona un destino para el script.  
