...
# <a name="use-column-sets"></a>Usar conjuntos de columnas
 ...
 Para definir un conjunto de columnas, use las palabras clave *<nombreDeConjuntoDeColumnas>* FOR ALL_SPARSE_COLUMN de las instrucciones [CREATE TABLE](/sql/t-sql/statements/create-table-transact-sql) o [ALTER TABLE](/sql/t-sql/statements/alter-table-transact-sql).  
...
-   El conjunto de columnas no puede modificarse. Para modificar un conjunto de columnas, es preciso eliminarlo y volver a crearlo.  
...
-   Para obtener más información sobre los datos devueltos por la función COLUMNS_UPDATED, vea [Usar columnas dispersas](use-sparse-columns.md).  
