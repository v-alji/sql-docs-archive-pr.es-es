...
## <a name="cursorrecompile-event-class-data-columns"></a>Columnas de datos de la clase de evento CursorRecompile  
...
|**EventClass**|**int**|Tipo de evento registrado = 75.|27|No|  
|**EventSequence**|**int**|Secuencia de la clase de evento **CursorRecompile** en un lote.|51|No|  
