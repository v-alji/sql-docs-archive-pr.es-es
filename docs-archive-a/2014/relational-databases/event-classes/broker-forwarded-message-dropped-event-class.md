...
|RoleName|`nvarchar`|Rol del identificador de conversación. Uno de los valores siguientes:<br /><br /> Initiator. Este agente inició la conversación.<br /><br /> Target. Este agente es el destino de la conversación.|38|No|  
