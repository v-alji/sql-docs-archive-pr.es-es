...
|EventClass|`int`|Tipo de evento = 100.|27|No|  
...
|ObjectName|`nvarchar`|Nombre del parámetro al que se hace referencia.|34|Sí|  
...
|TextData|`ntext`|Valores del parámetro de salida de RPC.|1|Sí|  
