...
|EventSubClass|`int`|Tipo de subclase de evento:<br /><br /> 1 = quitar acierto. Se ha quitado de la caché un plan de consulta compilado.<br /><br /> 2 = vaciar caché de procedimientos. Se han quitado todas las entradas de la caché de procedimientos.|21|Sí|  
