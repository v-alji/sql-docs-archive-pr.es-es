...
---
# <a name="audit-server-object-management-event-class"></a>Audit Server Object Management, clase de eventos
  La clase de eventos **Audit Server Object Management** se produce en el caso de CREATE, ALTER o DROP para objetos de servidor.  
  
## <a name="audit-server-object-management-event-class-data-columns"></a>Columnas de datos de la clase de eventos Audit Server Object Management  
...
|**EventSubClass**|**int**|Tipo de la subclase de eventos.<br /><br /> 1=Crear<br /><br /> 2=Modificar<br /><br /> 3=Quitar<br /><br /> 4=Volcar<br /><br /> 7=Credencial asignada al inicio de sesión<br /><br /> 9=Se quita la asignación de credencial<br /><br /> 11=Cargar|21|Sí|  
