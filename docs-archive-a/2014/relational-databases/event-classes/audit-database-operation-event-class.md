...
## <a name="audit-database-operation-event-class-data-columns"></a>Columnas de datos de la clase de eventos Audit Database Operation  
...
|**EventSubClass**|**int**|Tipo de la subclase de eventos.<br /><br /> 1=Punto de comprobación<br /><br /> 2=Suscribir a notificación de consulta|21|Sí|  
