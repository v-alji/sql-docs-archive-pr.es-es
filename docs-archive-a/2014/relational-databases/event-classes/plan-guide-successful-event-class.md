...
|LoginName|`nvarchar`|Nombre del inicio de sesión del usuario ( [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Inicio de sesión de seguridad de o [!INCLUDE[msCoName](../../includes/msconame-md.md)] credenciales de inicio de sesión de Windows con el formato dominio \\ *nombreDeUsuario*).|11|Sí|  
...
## <a name="see-also"></a>Consulte también  
 [Guía de plan incorrecta (clase de eventos)](plan-guide-unsuccessful-event-class.md)   
