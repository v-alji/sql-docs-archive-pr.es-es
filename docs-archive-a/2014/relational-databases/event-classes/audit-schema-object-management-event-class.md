...
---
# <a name="audit-schema-object-management-event-class"></a>Audit Schema Object Management, clase de eventos
  La clase de eventos **Audit Schema Object Management** se produce cuando se crean, modifican o quitan objetos de servidor.  
  
## <a name="audit-schema-object-management-event-class-data-columns"></a>Columnas de datos de la clase de eventos Audit Schema Object Management  
...
|**EventSubClass**|**int**|Tipo de la subclase de eventos.<br /><br /> 1=Crear<br /><br /> 2=Modificar<br /><br /> 3=Quitar<br /><br /> 4=Volcar<br /><br /> 8=Transferir<br /><br /> 11=Cargar|21|Sí|  
