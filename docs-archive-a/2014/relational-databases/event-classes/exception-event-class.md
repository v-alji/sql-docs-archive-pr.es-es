...
---
# <a name="exception-event-class"></a>Exception, clase de eventos
  La clase de eventos Exception indica que se ha producido una excepción en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
## <a name="exception-event-class-data-columns"></a>Columnas de datos de la clase de eventos Exception  
...
|Error|`int`|Número de error del evento.|31|Sí|  
|EventClass|`int`|Tipo de evento = 33.|27|No|  
...
|State|`int`|Estado del servidor.|30|Sí|  
