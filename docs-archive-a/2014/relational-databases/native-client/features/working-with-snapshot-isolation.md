...
### <a name="sqlgetinfo"></a>SQLGetInfo  
 La función [SQLGetInfo](../../native-client-odbc-api/sqlgetinfo.md) admite ahora el valor SQL_TXN_SS_SNAPSHOT que se ha agregado al tipo de información SQL_TXN_ISOLATION_OPTION.  
