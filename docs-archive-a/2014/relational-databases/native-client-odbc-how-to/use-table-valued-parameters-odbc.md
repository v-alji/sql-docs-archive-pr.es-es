...
author: rothja
ms.author: jroth
ms.openlocfilehash: acd73eac86448030f433a57f2e3436201c767baf
ms.sourcegitcommit: ad4d92dce894592a259721a1571b1d8736abacdb
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/04/2020
ms.locfileid: "87662886"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="d35ef-102">Usar parámetros con valores de tabla (ODBC)</span><span class="sxs-lookup"><span data-stu-id="d35ef-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="d35ef-103">Este ejemplo muestra cómo utilizar los parámetros de valores de tabla para insertar varias filas, con varias columnas, mediante una llamada al servidor.</span><span class="sxs-lookup"><span data-stu-id="d35ef-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="d35ef-104">Para obtener más información sobre los parámetros con valores de tabla, vea [parámetros con valores de tabla &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span><span class="sxs-lookup"><span data-stu-id="d35ef-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="d35ef-105">Para obtener más ejemplos del uso de parámetros con valores de tabla, vea [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span><span class="sxs-lookup"><span data-stu-id="d35ef-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="d35ef-106">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="d35ef-106">Example</span></span>  
 <span data-ttu-id="d35ef-107">También necesitará un origen de datos ODBC denominado TVPDemo.</span><span class="sxs-lookup"><span data-stu-id="d35ef-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="d35ef-108">La base de datos predeterminada para TVPDemo puede ser cualquier base de datos de prueba del equipo.</span><span class="sxs-lookup"><span data-stu-id="d35ef-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="d35ef-109">Este origen de datos debe estar basado en el controlador ODBC para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span><span class="sxs-lookup"><span data-stu-id="d35ef-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="d35ef-110">Si genera y ejecuta este ejemplo como una aplicación de 32 bits en un sistema operativo de 64 bits, debe crear el origen de datos ODBC con el Administrador ODBC en %windir%\SysWOW64\odbcad32.exe.</span><span class="sxs-lookup"><span data-stu-id="d35ef-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="d35ef-111">Este ejemplo se conecta a la instancia predeterminada de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] del equipo.</span><span class="sxs-lookup"><span data-stu-id="d35ef-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="d35ef-112">Para conectarse a una instancia con nombre, cambie la definición del origen de datos ODBC para especificar la instancia utilizando el formato servidor\instanciaConNombre.</span><span class="sxs-lookup"><span data-stu-id="d35ef-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="d35ef-113">De forma predeterminada, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] se instala en una instancia con nombre.</span><span class="sxs-lookup"><span data-stu-id="d35ef-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="d35ef-114">Compile el segundo fragmento de código (C++) con odbc32.lib y user32.lib.</span><span class="sxs-lookup"><span data-stu-id="d35ef-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="d35ef-115">Asegúrese de que la variable de entorno INCLUDE incluye el directorio que contiene sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="d35ef-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
