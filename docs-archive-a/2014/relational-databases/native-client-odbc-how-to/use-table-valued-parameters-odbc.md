...
## <a name="example"></a>Ejemplo  
 ...
 Compile el segundo fragmento de código (C++) con odbc32.lib y user32.lib. Asegúrese de que la variable de entorno INCLUDE incluye el directorio que contiene sqlncli.h.  
