...
-   [Enviar datos a una columna FILESTREAM mediante IRowsetFastUpload &#40;OLE DB&#41;](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Copie la tercera lista de código y péguela en un archivo denominado ICommandDownload.cpp.  
  
 Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib y oleaut32.lib.  
  
 Al ejecutar este ejemplo, debe pasar un nombre de servidor (o servidor\nombre_de_instancia).  
