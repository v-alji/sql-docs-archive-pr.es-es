...
ms.locfileid: "87675831"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-ole-db"></a><span data-ttu-id="eea99-102">Recuperar datos de una columna FILESTREAM utilizando ISequentialStream (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="eea99-102">Retrieve Data from a FILESTREAM Column Using ISequentialStream (OLE DB)</span></span>
  <span data-ttu-id="eea99-103">En este ejemplo se muestra el uso de una interfaz ISequentialStream en una interfaz ICommandText para recuperar un único registro de una columna Filestream.</span><span class="sxs-lookup"><span data-stu-id="eea99-103">This sample shows uses an ISequentialStream interface in an ICommandText interface to retrieve a single record from a Filestream column.</span></span>  
  
 <span data-ttu-id="eea99-104">Para obtener más información sobre la característica FileStream, vea [compatibilidad de filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="eea99-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="eea99-105">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="eea99-105">Example</span></span>  
 <span data-ttu-id="eea99-106">Asegúrese de que la variable de entorno INCLUDE incluye el directorio que contiene sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="eea99-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="eea99-107">Utilice uno de los siguientes ejemplos para crear la tabla de la que lee este ejemplo:</span><span class="sxs-lookup"><span data-stu-id="eea99-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="eea99-108">Enviar datos a una columna FILESTREAM usando ISequentialStream enlazada al parámetro de ICommandText &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="eea99-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="eea99-109">Enviar datos a una columna FILESTREAM mediante IRowsetFastUpload &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="eea99-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="eea99-110">Copie la primera lista de código y péguela en un archivo denominado ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="eea99-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="eea99-111">Copie la segunda lista de código y péguela en un archivo denominado ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="eea99-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="eea99-112">Copie la tercera lista de código y péguela en un archivo denominado ICommandDownload.cpp.</span><span class="sxs-lookup"><span data-stu-id="eea99-112">Copy the third code listing and paste it into a file called ICommandDownload.cpp.</span></span>  
  
 <span data-ttu-id="eea99-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib y oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="eea99-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="eea99-114">Al ejecutar este ejemplo, debe pasar un nombre de servidor (o servidor\nombre_de_instancia).</span><span class="sxs-lookup"><span data-stu-id="eea99-114">When this sample is run, you must pass a server name (or server\instance_name).</span></span>  
