...
# <a name="integrated-kerberos-authentication-ole-db"></a>Autenticación integrada de Kerberos (OLE DB)
 ...
 Para obtener más información sobre los SPN y la autenticación de Kerberos, vea [Compatibilidad con los nombres de la entidad de seguridad del servicio &#40;SPN&#41; en conexiones de cliente](../native-client/features/service-principal-name-spn-support-in-client-connections.md).  
...
## <a name="example"></a>Ejemplo  
 ...
 Asegúrese de que la variable de entorno INCLUDE incluye el directorio que contiene sqlncli.h. Compile con ole32.lib oleaut32.lib.  
