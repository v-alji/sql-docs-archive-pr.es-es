...
# <a name="odbc-api-support-for-enhanced-date-and-time-features"></a>Las API de ODBC admiten las características mejoradas de fecha y hora
  Las siguientes API de ODBC admiten la funcionalidad mejorada de fecha y hora:  
...
-   [SQLSpecialColumns](../native-client-odbc-api/sqlspecialcolumns.md)  
 ...
 Las siguientes API de copia masiva admiten la funcionalidad mejorada de fecha y hora:  
...
-   [bcp_gettypename](../native-client-odbc-extensions-bulk-copy-functions/bcp-gettypename.md)  
