...
# <a name="understanding-the-wmi-provider-for-server-events"></a>Descripción del proveedor WMI para eventos de servidor
 ...
 ![Diagrama de flujo del proveedor WMI para eventos del servidor](../../../2014/database-engine/dev-guide/media/wmi-provider-functional-spec.gif "Diagrama de flujo del proveedor WMI para eventos del servidor")
