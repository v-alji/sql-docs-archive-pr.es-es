...
2.  Haga clic con el botón derecho en la vista cuyas propiedades quiere ver y seleccione **Propiedades**.  
     ...
     **Enlazada a un esquema**  
     Indica si la vista está enlazada a un esquema. Los valores son True y False. Para obtener más información sobre las vistas enlazadas a esquemas, vea la sección SCHEMABINDING de [CREATE VIEW &#40;Transact-SQL&#41;](/sql/t-sql/statements/create-view-transact-sql).  
