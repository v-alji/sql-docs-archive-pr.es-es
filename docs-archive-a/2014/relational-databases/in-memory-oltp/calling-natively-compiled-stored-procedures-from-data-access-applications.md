...
-   Enlace los parámetros con `SQLBindParameter`.  
  
-   Prepare la llamada a procedimiento con `SQLPrepare.`  
...
## <a name="using-odbc-to-execute-a-natively-complied-stored-procedure"></a>Utilizar ODBC para ejecutar un procedimiento almacenado compilado de forma nativa  
