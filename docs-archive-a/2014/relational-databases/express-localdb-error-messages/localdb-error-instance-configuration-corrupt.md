...
|Texto del mensaje|La instancia de Local Database está dañada. Vea el registro de aplicación de Windows para obtener los detalles del error.|  
  
## <a name="explanation"></a>Explicación  
 Una configuración de instancia está dañada.  
  
## <a name="user-action"></a>Acción del usuario  
 Corrija manualmente la instancia dañada o elimínela explícitamente.  
