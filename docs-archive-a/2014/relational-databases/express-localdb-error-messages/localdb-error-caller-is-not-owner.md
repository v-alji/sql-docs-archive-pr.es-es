...
|Texto del mensaje|El autor de llamada de API no es el propietario de la instancia de Local Database.|  
  
## <a name="explanation"></a>Explicación  
 El usuario debe ser el propietario de la instancia para poder ejecutar la operación solicitada.  
  
## <a name="user-action"></a>Acción del usuario  
 Póngase en contacto con el propietario de la instancia para obtener ayuda.  
