...
-   Por tanto, CHANGETABLE(CHANGES ...) devolverá todos los cambios que se han producido después de la última versión de sincronización.  
     ...
     ![Ejemplo de resultado de una consulta de seguimiento de cambios](../../database-engine/media/queryoutput.gif "Ejemplo de resultado de una consulta de seguimiento de cambios")  
...
```  
 ...
 Para obtener más información sobre las transacciones de instantáneas, vea [SET TRANSACTION ISOLATION LEVEL &#40;Transact-SQL&#41;](/sql/t-sql/statements/set-transaction-isolation-level-transact-sql).  
