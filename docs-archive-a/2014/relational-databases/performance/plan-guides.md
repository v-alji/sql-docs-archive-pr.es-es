...
|Describe cómo crear una guía de plan para consultas con parámetros.|[Crear una guía de plan para consultas con parámetros](create-a-plan-guide-for-parameterized-queries.md)|  
