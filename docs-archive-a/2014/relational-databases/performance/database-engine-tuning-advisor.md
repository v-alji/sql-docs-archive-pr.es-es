...
-   Utilice la característica de servidor de prueba/producción. Para obtener más información, vea  [Reducir la carga de optimización del servidor de producción](reduce-the-production-server-tuning-load.md).  
