...
##  <a name="structure-of-non-xml-format-files"></a><a name="Structure"></a> Estructura de los archivos de formato no XML  
 ...
 ![Identifica los campos de un archivo de formato no XML](../../database-engine/media/mydepart-fmt-ident-c.gif "Identifica los campos de un archivo de formato no XML")  
