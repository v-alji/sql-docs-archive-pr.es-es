...
> [!NOTE]  
>  En el siguiente ejemplo se usa la vista de catálogo [sys.objects](/sql/relational-databases/system-catalog-views/sys-objects-transact-sql) en lugar de la vista de compatibilidad [sys.sysobjects](/sql/relational-databases/system-compatibility-views/sys-sysobjects-transact-sql) .  
...
> [!NOTE]  
>  Puede utilizar EXECUTE AS para cambiar temporalmente al contexto de seguridad del autor de la llamada. Para obtener más información, vea [EXECUTE AS &#40;Transact-SQL&#41;](/sql/t-sql/statements/execute-as-transact-sql).  
...
## <a name="see-also"></a>Consulte también  
 ...
 [EXECUTE AS &#40;cláusula de Transact-SQL&#41;](/sql/t-sql/statements/execute-as-clause-transact-sql)   
 [Vistas de catálogo &#40;Transact-SQL&#41;](/sql/relational-databases/system-catalog-views/catalog-views-transact-sql)   
 [Vistas de compatibilidad &#40;Transact-SQL&#41;](/sql/relational-databases/system-compatibility-views/system-compatibility-views-transact-sql)  
