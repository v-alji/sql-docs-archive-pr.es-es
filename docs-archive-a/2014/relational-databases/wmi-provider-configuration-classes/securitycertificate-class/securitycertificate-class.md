...
-   Establecer el certificado de seguridad con la huella digital SHA indicada para la instancia especificada de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
