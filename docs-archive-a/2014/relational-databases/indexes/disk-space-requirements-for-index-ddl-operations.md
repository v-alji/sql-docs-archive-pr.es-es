...
## <a name="temporary-disk-space-for-sorting"></a>Espacio temporal en disco para ordenación  
 ...
 Para obtener un ejemplo de cálculo de espacio en disco, vea [Index Disk Space Example](index-disk-space-example.md).  
...
## <a name="related-tasks"></a>Related Tasks  
 ...
 [Calcular el tamaño de una tabla](../databases/estimate-the-size-of-a-table.md)  
  
 [Estimar el tamaño de un índice clúster](../databases/estimate-the-size-of-a-clustered-index.md)  
  
 [Estimar el tamaño de un índice no clúster](../databases/estimate-the-size-of-a-nonclustered-index.md)  
  
 [Estimar el tamaño de un montón](../databases/estimate-the-size-of-a-heap.md)  
