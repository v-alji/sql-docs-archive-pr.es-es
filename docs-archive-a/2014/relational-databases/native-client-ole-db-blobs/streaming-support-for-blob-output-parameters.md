...
author: rothja
ms.author: jroth
ms.openlocfilehash: ef052971e4b6879113ae2bb42796842c915cdffd
ms.sourcegitcommit: ad4d92dce894592a259721a1571b1d8736abacdb
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/04/2020
ms.locfileid: "87750814"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="7f447-102">Compatibilidad con la transmisión por secuencias de parámetros de salida BLOB</span><span class="sxs-lookup"><span data-stu-id="7f447-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="7f447-103">Este tema contiene un ejemplo que muestra la compatibilidad de la transmisión por secuencias con los parámetros de salida BLOB, que enlaza los parámetros de salida BLOB como ISequentialStreams.</span><span class="sxs-lookup"><span data-stu-id="7f447-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="7f447-104">Puede quedarse bloqueado en los parámetros de salida de IMultipleResults::GetResult y recibir el valor de retorno DB_E_OBJECTOPEN.</span><span class="sxs-lookup"><span data-stu-id="7f447-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="7f447-105">El autor de la llamada debe comprobar si hay parámetros blob pendientes y leerlos completamente o liberarlos.</span><span class="sxs-lookup"><span data-stu-id="7f447-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="7f447-106">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="7f447-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="7f447-107">Código</span><span class="sxs-lookup"><span data-stu-id="7f447-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="7f447-108">Consulte también</span><span class="sxs-lookup"><span data-stu-id="7f447-108">See Also</span></span>  
 [<span data-ttu-id="7f447-109">BLOB y objetos OLE</span><span class="sxs-lookup"><span data-stu-id="7f447-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
