...
# <a name="lesson-3-adding-and-processing-models"></a>Lección 3: Adición y procesamiento de modelos
 ...
 Para completar las tareas de esta lección, usará el algoritmo de [clústeres de Microsoft](../../2014/analysis-services/data-mining/microsoft-clustering-algorithm.md) y el [algoritmo Bayes Naive de Microsoft](../../2014/analysis-services/data-mining/microsoft-naive-bayes-algorithm.md).  
