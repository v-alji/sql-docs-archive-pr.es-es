...
12. En la página **finalización del asistente** , en nombre de la **estructura de minería de datos**, escriba `Forecasting` .  
  
    > [!NOTE]  
    >  La opción para habilitar la obtención de detalles no está disponible para los modelos de serie temporal.  
  
13. En **nombre del modelo de minería de datos**, escriba `Forecasting` y, a continuación, haga clic en **Finalizar**.  
  
     El diseñador de minería de datos se abre para mostrar la estructura de minería de datos `Forecasting` que acaba de crear.  
