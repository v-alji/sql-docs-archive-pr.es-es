...
## <a name="returning-the-content-of-a-mining-model"></a>Devolver el contenido de un modelo de minería de datos  
 ...
 A continuación se encuentra un ejemplo genérico de SELECT FROM \<model> . Instrucción de contenido:  
...
2.  Copie el ejemplo genérico de SELECT FROM \<model> . Instrucción de contenido en la consulta en blanco.  
...
6.  En el cuadro de diálogo **Guardar como** , vaya a la carpeta correspondiente y asigne el nombre al archivo `SELECT_CONTENT.dmx` .  
...
## <a name="use-drillthrough"></a>Usar la obtención de detalles  
 ...
 A continuación se encuentra un ejemplo genérico de SELECT FROM \<model> . Instrucción CASEs:  
...
2.  Copie el ejemplo genérico de SELECT FROM \<model> . CASEs en la consulta en blanco.  
...
6.  En el cuadro de diálogo **Guardar como** , vaya a la carpeta correspondiente y asigne el nombre al archivo `SELECT_DRILLTHROUGH.dmx` .  
...
6.  En el cuadro de diálogo **Guardar como** , vaya a la carpeta correspondiente y asigne el nombre al archivo `SELECT_DISCRETE.dmx` .  
