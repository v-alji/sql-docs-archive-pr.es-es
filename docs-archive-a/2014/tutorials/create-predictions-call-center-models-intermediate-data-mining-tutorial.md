...
8.  Haga clic en la fila de los operadores de tipo de la columna 2 y escriba `6` .  
...
2.  En el Asistente para vistas del origen de datos, seleccione [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)] como origen de datos y, a continuación, haga clic en **siguiente**.  
