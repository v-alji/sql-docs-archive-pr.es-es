...
2.  En el cuadro de diálogo **Guardar resultado de consulta de minería de datos** , en **origen de datos**, seleccione [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] . También puede crear un origen de datos si desea guardar los datos en una base de datos relacional diferente.  
