...
4.  En el cuadro de diálogo **nuevo modelo de minería de datos** , en **nombre del modelo**, escriba `Call Center - LR` .  En **nombre del algoritmo**, seleccione **regresión logística de Microsoft**.  
...
1.  En la columna del nuevo modelo de minería de datos, `Call Center - LR` deje Fact CALLCENTER ID como la clave.  
...
2.  En la fila del parámetro HOLDOUT_SEED, haga clic en la celda vacía situada debajo de **valor**y escriba `1` . Haga clic en **OK**.  
