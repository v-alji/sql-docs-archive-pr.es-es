...
-   El *procesamiento* rellena los [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] objetos con datos de orígenes de datos relacionales.  
...
1.  Haga clic en la pestaña **estructura de minería** de datos o en la pestaña **modelos de minería** de datos del diseñador de minería de datos en [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] .  
