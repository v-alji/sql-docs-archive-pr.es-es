...
# <a name="use-annotations-in-packages"></a>Usar anotaciones en paquetes
 ...
 Para obtener más información sobre los cambios en el formato del archivo de paquete, vea [Formato de paquetes SSIS](../../2014/integration-services/ssis-package-format.md).  
  
 Cuando se guarda un paquete, el Diseñador [!INCLUDE[ssIS](../includes/ssis-md.md)] guarda las anotaciones en el paquete.  
  
### <a name="to-add-an-annotation-to-a-package"></a>Para agregar una anotación a un paquete  
  
-   [agregar una anotación a un paquete](../../2014/integration-services/add-an-annotation-to-a-package.md)  
