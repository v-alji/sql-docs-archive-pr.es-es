...
-   Generar el ensamblado directamente en la carpeta adecuada.
 ...
 Las siguientes carpetas de implementación en **c:\Archivos de programa\Microsoft SQL Server\120\DTS** se usan para los distintos tipos de objetos personalizados:
