...
## <a name="expression-examples"></a>Ejemplos de expresiones  
 Este ejemplo devuelve TRUE únicamente si la fecha actual no es el 4 de julio de 2003. Para obtener más información, consulte [GETDATE &#40;expresión de SSIS&#41;](getdate-ssis-expression.md).  
