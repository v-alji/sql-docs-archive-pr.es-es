...
---
# <a name="add-ssis-connection-manager"></a>Agregar administrador de conexiones SSIS
 ...
 Para obtener más información sobre los administradores de conexión, vea [Conexiones de Integration Services &#40;SSIS&#41;](connection-manager/integration-services-ssis-connections.md).  
