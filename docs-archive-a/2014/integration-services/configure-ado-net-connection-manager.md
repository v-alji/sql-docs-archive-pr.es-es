...
# <a name="configure-adonet-connection-manager"></a>Configurar el administrador de conexiones ADO.NET
 ...
 Para obtener más información acerca del administrador de conexiones ADO .NET, vea [ADO.NET Connection Manager](connection-manager/ado-net-connection-manager.md).  
