...
-   La tabla \<cdc-database>.cdc.xdbcdc_trace, que las instancias de CDC de Oracle usan para el registro y el seguimiento generales. Esto significa que los errores relacionados con una instancia CDC de Oracle específica se registran en la tabla de seguimiento de esa instancia.  
