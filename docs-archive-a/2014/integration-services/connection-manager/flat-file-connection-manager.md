...
## <a name="configuration-of-the-flat-file-connection-manager"></a>Configuración del administrador de conexiones de archivos planos  
 ...
 En algunos casos, si se deshabilita esta característica, se puede mejorar el rendimiento del paquete. Puede deshabilitar esta característica estableciendo la propiedad del administrador de conexiones de archivos planos, **AlwaysCheckForRowDelimiters**, en `False` .  
