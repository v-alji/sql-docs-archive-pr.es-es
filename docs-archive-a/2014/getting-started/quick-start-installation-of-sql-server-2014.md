...
## <a name="ssnoversion-installation"></a>Instalación de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Introducción a la documentación del producto para la compatibilidad con](../index.yml) [versiones anteriores](backward-compatibility.md) de SQL Server  
