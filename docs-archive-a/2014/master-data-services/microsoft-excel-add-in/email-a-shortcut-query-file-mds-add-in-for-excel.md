...
1.  Asegúrese de que los datos de la hoja de cálculo está en el formato que desee compartir. Para obtener más información sobre cómo filtrar datos y reordenar columnas, vea [filtrar datos antes de cargar &#40;Complemento MDS para Excel&#41;](filter-data-before-exporting-mds-add-in-for-excel.md) y [Reordenar columnas &#40;complemento MDS para Excel&#41;](reorder-columns-mds-add-in-for-excel.md).  
