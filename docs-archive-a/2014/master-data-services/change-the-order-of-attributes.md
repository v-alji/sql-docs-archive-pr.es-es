...
4.  Haga clic en la fila de la entidad que contiene los atributos cuyo orden desea cambiar.  
  
5.  Haga clic en **Editar entidad seleccionada**.  
  
6.  En la página **Editar entidad** , seleccione el atributo cuyo orden desea cambiar en **Atributos de miembro hoja**, **Atributos de miembro consolidados**o **Atributos de colección**y, a continuación, haga clic en la flecha arriba o en la flecha abajo para cambiar el orden.  
