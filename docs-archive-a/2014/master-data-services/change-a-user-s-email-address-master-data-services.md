...
### <a name="to-change-a-users-email-address-or-default-email-format"></a>Para cambiar la dirección de correo electrónico de un usuario o el formato de correo electrónico predeterminado  
  
1.  En [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)], haga clic en **Permisos de usuario y de grupo**.  
  
2.  En la página **Usuarios** , seleccione la fila del usuario que desea modificar.  
  
3.  Haga clic en **Editar usuario seleccionado**.  
  
4.  Sobre la pestaña **General** , haga clic en **Editar**.  
