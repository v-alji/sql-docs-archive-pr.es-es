...
3.  En la página **Administrar marcas de versión** , en el campo **Modelo** , seleccione un modelo.  
  
4.  En la cuadrícula, en la fila del nombre de marca, haga doble clic en el campo **Nombre** .  
  
5.  Escriba un nombre nuevo para la marca.  
