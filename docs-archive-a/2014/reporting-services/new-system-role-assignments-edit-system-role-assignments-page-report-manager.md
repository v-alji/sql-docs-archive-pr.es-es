 ...
 **Grupo o usuario**  
 Escriba el nombre de una cuenta de usuario o grupo de su dominio. Si el servidor de informes se ejecuta con una cuenta local, debe especificar usuarios o grupos locales. Si el servidor de informes se ejecuta con una cuenta de dominio, debe especificar usuarios o grupos de dominio. Escriba la cuenta con este formato: \<domain> \\<cuenta \> .  
