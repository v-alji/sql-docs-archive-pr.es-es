...
```
 ...
 Hay también muchas herramientas que puede descargar para leer registros ULS. Por ejemplo, el [visor de registros de SharePoint](https://sharepointlogviewer.codeplex.com/) o el [visor de registros ULS de SharePoint](http://ulsviewer.codeplex.com/workitem/list/basic). Ambos están disponibles en CodePlex.
