...
## <a name="rsreportserver-configuration-settings-for-application-domains"></a>Valores de configuración de RSReportServer para dominios de aplicación  
 Los valores de configuración se especifican en el archivo [RSReportServer.config](rsreportserver-config-configuration-file.md). El ejemplo siguiente muestra los valores de configuración predeterminados para el comportamiento de reciclaje del dominio de aplicación.  
