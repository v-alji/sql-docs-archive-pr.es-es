...
3.  Un atacante crea un vínculo a la página web o al servidor de informes que especifica el valor del parámetro con el formato "JavaScript: \<malicious script here> " y envía ese vínculo a alguien más en un ataque por señuelo.  
