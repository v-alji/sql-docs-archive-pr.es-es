...
1.  Abra RSReportServer.config en un editor de texto.  
     ...
     El archivo se encuentra en * \<drive> :* \Archivos de programa\Microsoft SQL Server\MSRS12. MSSQLSERVER\Reporting Services\ReportServer.  
