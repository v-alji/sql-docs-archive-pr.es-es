...
-   Definiciones de rol que definen un conjunto de tareas. Algunos ejemplos de definiciones de rol son **Administrador del sistema**, **Administrador de contenido**y **Publicador**.  
 ...
 ![Diagrama de asignaciones de roles](../media/report-securityarch.gif "Diagrama de asignaciones de roles")  
...
## <a name="predefined-role-assignments"></a>Asignaciones de roles predefinidos  
 ...
 Para obtener más información sobre las asignaciones de roles predefinidos que proporcionan la seguridad predeterminada, vea [Roles predefinidos](role-definitions-predefined-roles.md).  
