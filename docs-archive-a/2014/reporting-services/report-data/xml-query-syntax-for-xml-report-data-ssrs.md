...
|---------------------|-------------------|  
|Datos XML del servicio web obtenidos a través del método ListChildren .|`<Query>`<br /><br /> `<Method Name="ListChildren" Namespace="https://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices" />`<br /><br /> `</Query>`|  
...
|\<xmldp:Query xmlns:xmldp="https://schemas.microsoft.com/sqlserver/2005/02/reporting/XmlDPQuery" xmlns:ns="https://schemas.microsoft.com/..."><br /><br /> \<xmldp:ElementPath>Raíz {} /NS: elemento2/nodo\</xmldp:ElementPath><br /><br /> \</xmldp:Query>|Valor D<br /><br /> Valor E<br /><br /> Valor F|  
