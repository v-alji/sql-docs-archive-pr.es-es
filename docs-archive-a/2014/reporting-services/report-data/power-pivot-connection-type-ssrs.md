...
## <a name="connection-string"></a>Cadena de conexión  
 La cadena de conexión es la dirección URL del libro PowerPivot publicado en SharePoint en la galería de PowerPivot u otra biblioteca, por ejemplo, http://contoso-srv/subsite/PowerPivotLibrary/ContosoSales.xlsx .  
