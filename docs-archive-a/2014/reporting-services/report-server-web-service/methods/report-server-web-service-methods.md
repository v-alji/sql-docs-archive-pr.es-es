...
|Tema|Descripción|  
|-----------|-----------------|  
|[Extremos de servicios web del servidor de informes](report-server-web-service-endpoints.md)|Describe los puntos finales de ejecución y administración del servicio web del servidor de informes.|  
...
|[Métodos para los modelos](../report-server-web-service.md)|Describe métodos que puede utilizar para administrar los modelos.|  
...
## <a name="see-also"></a>Consulte también  
 [Obtener acceso a la API de SOAP](../accessing-the-soap-api.md)   
