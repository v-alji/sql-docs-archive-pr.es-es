...
# <a name="reporting-services-properties"></a>Propiedades de Reporting Services
 ...
 Los métodos de servicio web siguientes recuperan y establecen [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] las propiedades.  
