...
## <a name="setting-delivery-options"></a>Establecer opciones de entrega  
 ...
 Copia automática  
 Si va a usar la característica de copia automática para copiar automáticamente la versión más reciente de un archivo en varias ubicaciones, el archivo se copiará al habilitarse **Sobrescribir** . Si ha usado **incremento automático** o **ninguno**, la entrega no se realizará correctamente y se producirá el `rsDeliveryError` error.  
