...
2.  Expanda la carpeta Programaciones compartidas, haga clic con el botón derecho en la programación que quiere eliminar y, luego, haga clic en **Eliminar**. Aparece el cuadro de diálogo **Eliminar elementos del catálogo** .  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Pausar y reanudar programaciones compartidas](pause-and-resume-shared-schedules.md)   
