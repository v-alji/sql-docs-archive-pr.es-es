...
##  <a name="characteristics-of-a-report-that-is-delivered-to-a-shared-folder"></a><a name="bkmk_Characteristics"></a>Características de un informe que se entrega en una carpeta compartida  
