...
2.  Seleccione la región de datos en la superficie de diseño y, a continuación, haga clic con el botón derecho en _\<data region>_ **propiedades**. Si se trata de un medidor, seleccione **Propiedades del panel de medidores**. _\<data region>_ Se abrirá el cuadro de diálogo **propiedades** .  
