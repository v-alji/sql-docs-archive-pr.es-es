 ...
 *scope*  
 (`String`) (opcional). El nombre de un grupo o una región de datos, o null ( `Nothing` en [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] ), que especifica el ámbito del que se va a recuperar el valor anterior especificado por *Expression*.  
...
## <a name="remarks"></a>Observaciones  
 ...
 Si *Expression* no contiene un agregado, la función tiene como `Previous` valor predeterminado el ámbito actual del elemento de informe.  
