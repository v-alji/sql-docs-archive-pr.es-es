...
##  <a name="map-wizard-and-map-layer-wizard-pages"></a><a name="BackToTop"></a>Páginas del Asistente para mapas y del Asistente para capas de mapa
...
1.  [Elija un origen de datos espaciales](#SpatialDataSource). Los datos espaciales pueden proceder de la galería de mapas, de un archivo de forma de Environmental Systems Research Institute, Inc. o de los datos espaciales de una base de datos relacional de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .
...
3.  [Elija visualización de mapa](#Visualization). Elija el tipo de mapa que desea crear.
...
6.  [Elija el conjunto de los conjuntos analíticos](#AnalyticalData). Especifique un origen de datos para los datos analíticos.
...
###  <a name="what-is-the-map-gallery"></a><a name="MapGallery"></a>¿Qué es la galería de mapas?
...
###  <a name="what-is-an-esri-shapefile"></a><a name="Shapefile"></a>¿Qué es un archivo Esri de ESRI?
 Un archivo de forma ESRI es un conjunto de archivos con datos que cumplen el formato de datos espaciales de los archivos de forma del Environmental Systems Research Institute, Inc. (ESRI). El conjunto de archivos suele incluir el *\<filename>* archivo. debajo que contiene los datos espaciales y un archivo de compatibilidad, *\<filename>* . DBF.
...
###  <a name="where-can-i-get-esri-shapefiles"></a><a name="GetShapefiles"></a>¿Dónde puedo obtener el archivos ESRI de ESRI?
...
###  <a name="what-is-a-sql-server-spatial-query"></a><a name="SqlServerSpatial"></a>¿Qué es una consulta espacial SQL Server?
...
##  <a name="choose-spatial-data-and-map-view-options"></a><a name="MapView"></a>Elegir opciones de datos espaciales y vista de mapa
...
###  <a name="what-is-a-bing-map-tile-background"></a><a name="Tiles"></a>¿Qué es un fondo de mosaico de Bing Maps?
...
-   **Viario.** Muestra un estilo de mapa de carreteras con un fondo blanco.

-   **Aéreo.** Muestra solo una vista aérea. En este modo no se muestra ningún texto.

-   **Mixta.** Muestra la combinación de las vistas **Carretera** y **Aéreo** .
...
##  <a name="choose-map-visualization"></a><a name="Visualization"></a>Elegir visualización de mapa
...
##  <a name="choose-the-analytical-dataset"></a><a name="AnalyticalData"></a>Elección del conjunto de los análisis
...
##  <a name="choose-color-theme-and-data-visualization"></a><a name="ThemeandVisualization"></a>Elegir tema de color y visualización de datos
...
-   **Cuadrícula.** Puede especificar reglas de color y de ancho.

-   **Cima.** Puede especificar reglas de color, reglas de tamaño y reglas de tipo de marcador.
...
## <a name="see-also"></a>Consulte también
 [Solucionar problemas de informes: informes de mapa &#40;generador de informes y ssrs&#41;](troubleshoot-reports-map-reports-report-builder-and-ssrs.md) [planear un informe de mapa &#40;generador de informes y SSRS](plan-a-map-report-report-builder-and-ssrs.md)&#41;mapas &#40;generador de informes [y SSRS&#41;](maps-report-builder-and-ssrs.md)
