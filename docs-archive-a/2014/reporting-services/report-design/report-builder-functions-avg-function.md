 ...
 *expression*  
 (`Float`) Expresión en la que se lleva a cabo la agregación.  
...
## <a name="example"></a>Ejemplo  
 Los dos ejemplos de código siguientes proporcionan un promedio de todos los valores del campo `Cost` contenidos en un conjunto de datos denominado `Inventory`.  
