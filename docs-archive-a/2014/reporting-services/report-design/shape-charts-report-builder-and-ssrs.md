...
# <a name="shape-charts-report-builder-and-ssrs"></a>Gráficos de formas (Generador de informes y SSRS)
 ...
 ![Gráfico de embudo](../media/rs-funnelchart.gif "Gráfico de embudo")  
...
-   Los efectos 3D mejoran considerablemente el aspecto general de un tipo de gráfico de formas.  
