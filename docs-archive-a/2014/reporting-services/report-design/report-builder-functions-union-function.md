...
## <a name="return"></a>Valor devuelto  
 Devuelve un objeto espacial, `SqlGeometry` o bien `SqlGeography` , en función del tipo de expresión. Para obtener más información sobre los `SqlGeometry` `SqlGeography` tipos de datos espaciales y, vea [información general sobre tipos de datos espaciales](../../relational-databases/spatial/spatial-data-types-overview.md).  
