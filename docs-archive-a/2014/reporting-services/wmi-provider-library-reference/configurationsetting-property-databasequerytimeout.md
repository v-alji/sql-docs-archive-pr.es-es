...
---
# <a name="databasequerytimeout-property-wmi-msreportserver_configurationsetting"></a>Propiedad DatabaseQueryTimeout (MSReportServer_ConfigurationSetting de WMI)
