...
# <a name="choose-the-table-layout"></a>Elegir el diseño de tabla
  Utilice esta página del Asistente para informes para seleccionar el diseño de la tabla en el informe.  
 ...
 **Incluir subtotales**  
 Elija esta opción si desea incluir un subtotal para los campos numéricos del informe. Si se ha seleccionado **Escalonado** , el subtotal aparece en las filas de encabezado de grupo. Si se ha seleccionado **Bloquear** , el subtotal aparece en las filas de pie de grupo.  
