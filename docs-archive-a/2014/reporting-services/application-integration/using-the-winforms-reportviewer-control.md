...
3.  Arrastre el control ReportViewer a la superficie de diseño de Windows Form.  
 ...
 ![Seleccionar informe local](../../../2014/reporting-services/media/windowsapp-localreportsettings.png "Seleccionar informe local")  
...
6.  Una vez cambiado el nombre del informe, seleccione el archivo y busque la ventana Propiedades. Cambie la propiedad **Copiar en el directorio de salida** a **Copiar si es posterior**.  
     ...
     ![Configurar los valores de Copiar en el directorio de salida](../../../2014/reporting-services/media/windowsapp-copytooutputsetting.png "Configurar los valores de Copiar en el directorio de salida")  
