...
##  <a name="solutions-and-projects"></a><a name="bkmk_SolutionsandProjects"></a>Soluciones y proyectos
...
##  <a name="configurations"></a><a name="bkmk_Configurations"></a>Configuraciones
...
##  <a name="report-server-projects"></a><a name="bkmk_ReportServerProjects"></a>Proyectos de servidor de informes
...
###  <a name="report-data-pane"></a><a name="bkmk_ReportDataPane"></a>Panel datos de informe
...
###  <a name="grouping-pane"></a><a name="bkmk_GroupingPane"></a>Panel de agrupación
...
###  <a name="toolbox"></a><a name="bkmk_Toolbox"></a>Herramientas
...
###  <a name="properties-pane"></a><a name="bkmk_PropertiesPane"></a>Panel Propiedades
...
-   Establecer las propiedades del elemento seleccionado en la superficie de diseño. Algunas propiedades proporcionan una lista desplegable de valores. También puede escribir directamente el valor en la celda. En algunas propiedades se incluye una colección de valores, que se indica con el valor **(Colección)**. La mayoría de las propiedades pueden aceptar una expresión; las expresiones complejas se indican mediante el valor **\<Expression>** . Haga clic **\<Expression>** para abrir el cuadro de diálogo **expresión** . Para obtener más información, vea [Expression Dialog Box](../expression-dialog-box.md).
...
###  <a name="document-outline"></a><a name="bkmk_DocumentOutline"></a>Esquema del documento
...
###  <a name="task-list"></a><a name="bkmk_TaskList"></a>Lista de tareas
...
##  <a name="report-designer-design-view"></a><a name="bkmk_ReportDesignerDesignView"></a>Diseñador de informes vista de diseño
...
##  <a name="report-designer-preview"></a><a name="bkmk_ReportDesignerPreview"></a> Vista previa del Diseñador de informes
...
##  <a name="report-designer-menus"></a><a name="bkmk_ReportDesignerMenus"></a>Menús Diseñador de informes
...
###  <a name="format-menu"></a><a name="FormatMenu"></a>Menú formato
...
###  <a name="report-menu"></a><a name="ReportMenu"></a>Menú informe
...
###  <a name="view-menu"></a><a name="ViewMenu"></a>Menú Ver
...
###  <a name="project-menu"></a><a name="ProjectMenu"></a>Menú proyecto
...
##  <a name="report-designer-toolbars"></a><a name="bkmk_ReportDesignerToolbars"></a>Diseñador de informes barras de herramientas
...
##  <a name="source-control"></a><a name="bkmk_SourceControl"></a>Control de código fuente
...
##  <a name="custom-report-templates"></a><a name="bkmk_CustomReportTemplates"></a>Plantillas de informe personalizadas
...
##  <a name="command-line-support-for-sql-server-data-tools"></a><a name="bkmk_CommandLineSupportForssdt"></a>Compatibilidad con la línea de comandos para SQL Server Data Tools
 [!INCLUDE[ssBIDevStudio](../../../includes/ssbidevstudio-md.md)]se basa en [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] 10,0 y en la aplicación de devenv.exe subyacente. Para poder usar estas opciones, debe establecer valores válidos para los dos elementos siguientes:
...
##  <a name="keyboard-shortcuts-in-reporting-services"></a><a name="bkmk_KeyboardShortcuts"></a> Métodos abreviados de teclado en Reporting Services
...
## <a name="see-also"></a>Consulte también
 [Explorador de soluciones](../../ssms/solution/solution-explorer.md) [Reporting Services informes &#40;](../reports/reporting-services-reports-ssrs.md) el lenguaje de definición de informes&#41;SSRS [&#40;SSRS&#41;](../reports/report-definition-language-ssrs.md) la [implementación y la compatibilidad de versiones en SQL Server Data Tools &#40;SSRS&#41;](deployment-and-version-support-in-sql-server-data-tools-ssrs.md)
