...
4.  Compruebe que el tipo de conexión es Microsoft SQL Server y, a continuación, en el cuadro **cadena de conexión** , escriba: **origen de datos = \<servername> **
     ...
     \<servername>, por ejemplo Report001, especifica un equipo en el que se ha instalado una instancia del SQL Server Motor de base de datos. Dado que los datos del informe no se extraen de una base de datos de SQL Server, no necesita incluir el nombre de una base de datos. Para analizar la consulta se utiliza la base de datos predeterminada en el servidor especificado.
...
##  <a name="3-add-graphics"></a><a name="Graphics"></a>3. agregar gráficos
...
##  <a name="4-add-free-form-text"></a><a name="Text"></a>4. agregar texto de forma libre
...
##  <a name="6-format-data"></a><a name="Format"></a>6. dar formato a los datos
...
##  <a name="8-optional-add-a-line-to-separate-areas-of-the-report"></a><a name="Line"></a>8. (opcional) agregar una línea para separar áreas del informe
...
##  <a name="9-optional-add-summary-data-visualization"></a><a name="Visualization"></a>9. (opcional) agregar visualización de datos resumidos
