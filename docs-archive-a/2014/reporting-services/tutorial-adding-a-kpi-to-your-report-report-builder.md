...
1.  En la tabla, haga clic con el botón secundario en dos celdas hacia abajo en la `[Sum(Sales)]` celda (la fila de subtotal que muestra las ventas de una subcategoría) y, a continuación, haga clic en **propiedades de cuadro de texto**.  
