...
## <a name="see-also"></a>Consulte también
 [Diseñador de alertas](../../2014/reporting-services/data-alert-designer.md) [de datos crear una alerta de datos en el diseñador de alertas de datos](create-a-data-alert-in-data-alert-designer.md) [Reporting Services alertas de datos](../ssms/agent/alerts.md)
