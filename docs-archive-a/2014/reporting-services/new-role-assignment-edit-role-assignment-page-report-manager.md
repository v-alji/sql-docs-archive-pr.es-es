 ...
 **Nombre de usuario o grupo**  
 Escriba el nombre de una cuenta de usuario o de grupo para la que se va a crear la asignación de roles. El nombre de grupo o de usuario debe ser una cuenta de dominio de Windows. Escriba la cuenta con este formato: \<domain> \\<cuenta \> .  
