...
## <a name="see-also"></a>Consulte también
 Extensiones de [herramientas de Reporting Services](../tools/reporting-services-tools.md) [&#40;SSRS&#41;](../extensions-ssrs.md) [Reporting Services servidor de informes](../reporting-services-report-server.md)
