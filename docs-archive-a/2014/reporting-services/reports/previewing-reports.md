...
- Haciendo clic en el botón **iniciar** de la [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] barra de herramientas estándar.  
...
> [!NOTE]  
> Antes de depurar un informe es preciso establecer un elemento de inicio. Para establecer un elemento de inicio, en Explorador de soluciones, haga clic con el botón secundario en el proyecto de informe, haga clic en **propiedades**y, a continuación, en `StartItem` , seleccione el nombre del informe que desea mostrar.  
