...
-   Agregue la entrada siguiente al archivo RSReportDesigner.config bajo el elemento **Designer** , reemplazando el `Name` atributo por el nombre que proporcionó en las entradas anteriores.  
