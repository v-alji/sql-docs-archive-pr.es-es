...
# <a name="report-manager-f1-help"></a>Administrador de informes (Ayuda F1)
  En los temas siguientes se proporciona ayuda en el nivel de página para [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] Administrador de informes. Hay un tema para cada página de la aplicación. Puede que no todas las páginas estén disponibles. La configuración de seguridad determina las páginas a las que se puede obtener acceso. Para obtener acceso a estos temas desde el Administrador de informes, haga clic en **Ayuda** en la barra de herramientas principal.  
  
## <a name="in-this-section"></a>En esta sección  
  
-   [Página Elegir vínculo](../../2014/reporting-services/choose-link-page-report-manager.md)  
  
-   [Página para elegir la ubicación del elemento](../../2014/reporting-services/choose-item-location-page-report-manager.md)  
  
-   [Página de informes click-through](../../2014/reporting-services/clickthrough-reports-page-report-manager.md)  
  
-   [Página Contenido](../../2014/reporting-services/contents-page-report-manager.md)  
  
-   [Página Nueva suscripción controlada por datos](../../2014/reporting-services/create-data-driven-subscription-page-report-manager.md)  
  
-   [Página Selección de origen de datos](../../2014/reporting-services/data-source-selection-page-report-manager.md)  
...
-   [Página de error](../../2014/reporting-services/error-page-report-manager.md)  
...
-   [Página Mover elementos](../../2014/reporting-services/move-items-page-report-manager.md)  
  
-   [Página Mis suscripciones](../../2014/reporting-services/my-subscriptions-page-report-manager.md)  
  
-   [Página Nuevo origen de datos](../../2014/reporting-services/new-data-source-page-report-manager.md)  
  
-   [Página Nueva carpeta](../../2014/reporting-services/new-folder-page-report-manager.md)  
  
-   [Página Nuevo informe vinculado](../../2014/reporting-services/new-linked-report-page-report-manager.md)  
...
-   [Página de propiedades seguridad (elementos)](../../2014/reporting-services/security-properties-page-items-report-manager.md)  
  
-   [Página Programaciones](../../2014/reporting-services/schedules-page-report-manager.md)  
