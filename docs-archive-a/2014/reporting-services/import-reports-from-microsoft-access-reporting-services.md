...
# <a name="import-reports-from-microsoft-access-reporting-services"></a>Importar informes desde Microsoft Access (Reporting Services)
  En Diseñador de informes, puede importar informes desde una [!INCLUDE[msCoName](../includes/msconame-md.md)] base de datos o un proyecto de Access. Deberá instalar Access 2002 o una versión posterior en el mismo equipo en el que está instalado el Diseñador de informes.  
