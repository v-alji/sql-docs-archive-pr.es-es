...
||||  
|Modelos de informe|No es aplicable.|No necesita una cadena de conexión para un modelo de informe. En el Generador de informes, vaya al servidor de informes y seleccione el archivo .smdl que constituye el modelo de informe.|  
