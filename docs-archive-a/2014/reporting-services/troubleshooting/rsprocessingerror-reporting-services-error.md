...
-   El procesamiento de *\<report item type>* para *\<report item name>* no se puede realizar. No se pueden comparar datos de tipos *\<type>* y *\<type>* . Compruebe el tipo de datos devuelto por *\<report item name>* .  
  
-   No se pudo evaluar el *\<property name>* .  
  
-   No se pudo evaluar el *\<property name>* . Hace referencia a un campo de conjunto de información que tiene un error: *\<error string>* .  
