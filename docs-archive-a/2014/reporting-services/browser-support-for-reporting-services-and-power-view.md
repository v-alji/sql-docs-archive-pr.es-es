...
##  <a name="power-view-browser-scenarios"></a><a name="bkmk_powerview"></a>Escenarios del explorador Power View
...
###  <a name="power-view-on-sharepoint-server-and-reporting-services-sharepoint-integrated-mode"></a><a name="bkmk_powerview_on_SSRS"></a>Power View en el servidor de SharePoint y Reporting Services el modo integrado de SharePoint  
...
- Para obtener más información acerca de la compatibilidad con exploradores de SharePoint 2013, consulte [planear la compatibilidad con exploradores en sharepoint 2013](https://technet.microsoft.com//library/cc263526\(office.15\).aspx) ( https://technet.microsoft.com/library/cc263526(office.15).aspx) .  
...
###  <a name="power-view-on-excel-services-or-the-excel-web-app-on-sharepoint-online"></a><a name="bkmk_powerview_on_ExcelServices"></a>Power View en Excel Services o Excel Web App en SharePoint Online
...
##  <a name="report-manager-browser-requirements-native-mode"></a><a name="bkmk_reportmanager"></a>Requisitos del explorador Administrador de informes (modo nativo)
...
##  <a name="browser-requirements-for-viewing-reports"></a><a name="bkmk_reportviewer"></a>Requisitos del explorador para ver informes
...
###  <a name="authentication-requirements"></a><a name="bkmk_authentication"></a>Requisitos de autenticación
...
##  <a name="browser-support-for-reportviewer-web-server-controls-in-visual-studio"></a><a name="bkmk_controls"></a>Compatibilidad del explorador con los controles de servidor Web ReportViewer en Visual Studio
...
|**Chrome (última versión publicada)**|Sí|Sí|Sí|Sí|Sí|No compatible|Imprimir y ampliar y reducir no se admiten.|  
 ...
 <sup>1</sup> En el modo estándar, Internet Explorer 7,0 y 8,0 no muestran líneas inclinadas en los informes. Si usa líneas inclinadas en los informes, establezca la página ASP.NET para que se ejecute en modo Quirks en Internet Explorer. Para ello, busque la \<!DOCTYPE> etiqueta en la página de ASP.net. O bien, si usa una página maestra, puede encontrar la etiqueta en el archivo .master. Esta etiqueta tiene la siguiente apariencia:  
  
```
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">  
```
  
 Reemplace la \<!DOCTYPE> etiqueta por la siguiente etiqueta:  
  
```
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">  
```
  
 Para obtener más información sobre los modos de compatibilidad en Internet Explorer, vea [definir la compatibilidad de documentos](https://go.microsoft.com/fwlink/?LinkId=180380) ( https://go.microsoft.com/fwlink/?LinkId=180380) .  
