...
-   **Día** define una programación que se ejecuta en los días seleccionados a una hora específica. Los días se pueden especificar de las siguientes maneras: cada \<*day*> , cada día de la semana y cada \<*number*> día. Al elegir un método se anulan los demás, aunque los demás días aparezcan seleccionados.  
