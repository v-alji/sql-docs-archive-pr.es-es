...
||Servidor de informes|Complemento|Versión de SharePoint|Compatible|  
|-|-------------------|-------------|------------------------|---------------|  
...
|11|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP2|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] y [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP2|SharePoint 2007|Sí|  
 ...
 Para obtener más información sobre [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] las características y los modos del servidor de informes, vea [Reporting Services servidor de informes](../reporting-services-report-server.md).  
