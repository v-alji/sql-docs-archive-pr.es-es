...
4.  [Cambiar el tipo de datos predeterminado y otras propiedades de un parámetro de informe](#ChangeDefaultProperties)  
  
    1.  [Agregar un conjunto de datos para proporcionar los valores disponibles y nombres para mostrar](#AddDataset)  
  
    2.  [Especificar valores disponibles para crear una lista desplegable de valores](#AvailableValues)  
  
    3.  [Especificar valores predeterminados para que el informe se ejecute automáticamente](#DefaultValues)  
  
    4.  [Buscar un valor de un conjunto de datos que tiene pares de name y valor](#NameValue)  
  
5.  [Mostrar el valor de parámetro seleccionado en el informe](#Expression)  
  
6.  [Utilizar el parámetro de informe en un filtro](#Filter)  
  
7.  [Cambiar el parámetro de informe a fin de que acepte varios valores](#Multivalued)  
...
3.  Agregue la siguiente [!INCLUDE[tsql](../includes/tsql-md.md)] `WHERE` cláusula como última línea de la consulta:  
  
    ```  
    WHERE StoreID = (@StoreID)  
    ```  
  
     La `WHERE` cláusula limita los datos recuperados al identificador del almacén especificado por el parámetro de consulta *@StoreID* .  
...
1.  En el panel datos de informe bajo el nodo **parámetros** , haga clic con el botón secundario *@StoreID* y, a continuación, haga clic en **propiedades de parámetro**.  
...
4.  Seleccione la opción **usar un conjunto de DataSet incrustado en mi informe** .  
  
5.  En **origen de datos**, en la lista desplegable, elija el origen de datos que ha creado en el primer procedimiento.  
...
1.  En el panel datos de informe, haga clic con el botón secundario en el parámetro *@StoreID* y, a continuación, haga clic en **propiedades de parámetro**.  
...
9. Obtenga una vista previa del informe.  
     ...
     En la barra de herramientas del visor de informes, el cuadro de texto del parámetro es ahora una lista desplegable que se muestra **\<Select a Value>** .  
  
10. En la lista desplegable, seleccione almacén de catálogos de Contoso y, a continuación, haga clic en **Ver informe**.  
...
2.  En el panel datos de informe, haga clic con el botón secundario *@StoreID* y, a continuación, haga clic en **propiedades de parámetro**.  
  
3.  Haga clic en **valores predeterminados**y, a continuación, en **obtener valores de una consulta**.  
...
7.  Obtenga una vista previa del informe.  
 ...
 En *@StoreID* el caso de, el visor de informes muestra el valor "Contoso Norteamérica Online Store". Este es el primer valor del conjunto de resultados para los **almacenes**de conjuntos de DataSet. El informe muestra la cantidad vendida de cámaras digitales para el identificador del almacén **199**.  
...
3.  Haga clic en **valores predeterminados**, haga clic en **especificar valores**y, a continuación, haga clic en **Agregar**. Se agrega una nueva fila de valor.  
...
6.  Cambie `equals` (=) a `IN` en la [!INCLUDE[tsql](../includes/tsql-md.md)] `WHERE` cláusula en la última línea de la consulta:  
...
8.  En la barra de herramientas del visor de informes, al lado de **Mostrar selecciones**, haga clic en `True` .  
