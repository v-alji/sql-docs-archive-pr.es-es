...
|aggregation|Tabla o estructura que contiene los datos precalculados de un cubo.|  
|alias|Nombre alternativo de una tabla o columna en expresiones que se suele usar para acortar el nombre de las referencias posteriores en el código, evitar posibles referencias ambiguas o proporcionar un nombre más descriptivo en el resultado de una consulta.|  
...
|cifrar|Método para mantener la confidencialidad de la información reservada mediante la modificación de los datos para que su formato sea ilegible.|  
...
|enteros|Categoría de tipo de datos numéricos que incluye los tipos de datos bigint, int, smallint y tinyint.|  
