...
# <a name="generate-data-feeds-from-a-report-report-builder-and-ssrs"></a>Generar fuentes de distribución de datos a partir de un informe (Generador de informes y SSRS)
  Puede generar fuentes de datos compatibles con Atom a partir de informes y, a continuación, utilizar las fuentes de datos en aplicaciones, como el [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] cliente, que pueden consumir fuentes de datos.  
