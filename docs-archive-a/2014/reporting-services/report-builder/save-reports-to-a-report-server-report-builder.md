...
> [!NOTE]  
>  La ubicación de la definición de informe guardado no afecta al hecho de que el informe se procese en el servidor o se procese localmente cuando obtiene una vista previa del informe.  
...
5.  En **Elementos de tipo**, seleccione el tipo de elemento de informe que está guardando. El tipo para los informes es Informes (*.rdl).  
  
### <a name="to-save-a-report-as-a-different-name"></a>Para guardar un informe con un nombre diferente  
  
1.  En el botón Generador de informes , haga clic en **Guardar como**. Se abre el cuadro de diálogo **Guardar como** _\<Report Item\>_ .  
