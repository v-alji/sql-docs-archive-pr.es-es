...
##  <a name="word-style-rendering"></a><a name="WordStyleRendering"></a>Representación de estilo de Word  
...
##  <a name="word-limitations"></a><a name="WordLimitations"></a>Limitaciones de palabras  
...
-   Word no repite las filas de encabezado en la página dos y versiones posteriores, aunque establezca la propiedad RepeatOnNewPage de la fila de encabezado estático en un Tablix (tabla, matriz o lista) en `True` . Puede definir saltos de página explícitos en su informe para obligar a las filas de encabezado a aparecer en nuevas páginas. Sin embargo, dado que Word aplica su propia paginación al informe representado exportado a Word, los resultados podrían variar y la fila de encabezado podría no repetirse previsiblemente. La fila de encabezado estática es la fila que contiene los encabezados de columna.  
...
##  <a name="availability-of-the-word-2003-renderer"></a><a name="AvailabilityWord"></a>Disponibilidad del representador de Word 2003  
...
##  <a name="differences-between-the-word-and-word-2003-renderers"></a><a name="Differences"></a>Diferencias entre los representadores de Word y Word 2003  
