...
# <a name="design-the-table-report-wizard"></a>Diseñar la tabla (Asistente para informes)
  Utilice esta página del Asistente para informes para seleccionar los campos que se incluirán en el informe.  
  
## <a name="options"></a>Opciones  
 **Campos disponibles**  
 Elija los campos que aparecerán en la página encima de la tabla, en una agrupación de tablas o en los detalles de la tabla. Para mover un campo de **Campos disponibles** a **Página**, **Grupo**o **Detalles**, selecciónelo y, a continuación, haga clic en **Página**, **Grupo**o **Detalles**. Otra alternativa es arrastrar el campo hasta el cuadro correspondiente.  
