...
---
# <a name="sql-server-2014-transaction-log-architecture-and-management"></a>Arquitectura y administración de registros de transacciones de SQL Server 2014

**Se aplica a:** SQL Server (a partir de 2008)
...
## <a name="additional-reading"></a>Lectura adicional  
